 ...
 */
public final class Loader_Extend implements LoaderErrorThrower {
    ...
    public interface Callback<T extends Loadable> {
         ...
         *
         * <p>Note: There is guaranteed to be a memory barrier between {@link Loadable#load()}
         * exiting
         ...
         * @param loadDurationMs    The duration in milliseconds of the load since {@link
         *                          #startLoading} was called.
         */
         ...
         *
         * <p>Note: If the {@link Loader} has not been released then there is guaranteed to be a
         * memory
         * barrier between {@link Loadable#load()} exiting and this callback being called. If the
         * {@link Loader} has been released then this callback may be called before {@link
         * Loadable#load()} exits.
         *
         ...
         * @param loadDurationMs    The duration in milliseconds of the load since {@link
         *                          #startLoading} was called up to the point at which it was
         *                          canceled.
         * @param released          True if the load was canceled because the {@link Loader} was
         ...
         * @param loadDurationMs    The duration in milliseconds of the load since {@link
         *                          #startLoading} was called up to the point at which the error
         *                          occurred.
         * @param error             The load error.
         * @param errorCount        The number of errors this load has encountered, including this
         *                          one.
     ...
     */
    public Loader_Extend(String threadName) {
     ...
     *
     * <p>The calling thread must be a {@link Looper} thread, which is the thread on which the
     * {@link
     ...
     * @throws IllegalStateException If the calling thread does not have an associated {@link
     *                               Looper}.
     */
    ...
    /**
     * Releases the {@link Loader}. This method should be called when the {@link Loader} is no
     * longer required.
     */
    public void release() {
        release(null);
    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        @Nullable
        private Loader_Extend.Callback<T> callback;
        ...
        public LoadTask(Looper looper, T loadable, Loader_Extend.Callback<T> callback,
