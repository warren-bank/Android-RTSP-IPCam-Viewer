...
public interface UdpDataSink {
     ...
     * @return {@link C_Extend#LENGTH_UNSET}) for support compatibility with {@link
     ...
     * Get the local port.
     *
     * @return The local port of the opened sink or {@link C_Extend#PORT_UNSET} if the sink isn't
     * opened.
     */
    int getLocalPort();
