...
/**
 * Extracts individual audio samples from G.711 RTP payload Supports payload format for G.711.0 and
 * G.711.1 Supports all G.711.1 modes: R1, R2A, R2B and R3 defines in RFC 5391 for ITU-T
 * Recomendation G.711.1
 */
