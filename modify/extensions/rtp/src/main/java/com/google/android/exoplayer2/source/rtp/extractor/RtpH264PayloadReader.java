...
/**
 * Extracts individual NAL Units from H.264 RTP payload Only supports two of three packetization
 * modes: Single NAL Unit and Non-Interleaved defines in RFC 6184 for H.264 NALU transmission over
 * RTP.
 */
