...
/* package */ final class RtcpPacketUtils {
    /**
     * Append two byte arrays. Appends packet B at the end of Packet A (Assuming Bytes as elements).
     * Returns packet ( AB ).
     *
    ...
    /**
     * Calculate number of octets required to fit the given number of octets into 32 bit boundary.
     *
     * @param lengthOfUnpaddedPacket The setLength of an unpadded packet
     * @return The required number of octets which must be appended to this packet to make it fit
     * into a 32 bit boundary.
     */
    ...
    /**
     * Calculate number of octets required to fit the given number of octets into 64 bit boundary.
     *
     * @param lengthOfUnpaddedPacket The setLength of an unpadded packet
     * @return The required number of octets which must be appended to this packet to make it fit
     * into a 64 bit boundary.
     */
