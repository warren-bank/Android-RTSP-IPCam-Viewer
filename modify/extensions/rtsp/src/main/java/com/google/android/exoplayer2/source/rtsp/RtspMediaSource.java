...
public final class RtspMediaSource extends BaseMediaSource implements Client.EventListener {
    ...
    public static final class Factory {
         ...
         *
         * @param factory The factory from which read the media will be obtained.
         */
    ...
    @Override
    public MediaPeriod createPeriod(MediaPeriodId mediaPeriodId, Allocator allocator, long l) {
        eventDispatcher = createEventDispatcher(mediaPeriodId);
...
//                .setPlayer(player)
    ...
    public void onMediaDescriptionInfoRefreshed(long durationUs) {
        //FIXME TAG
        refreshSourceInfo(new SinglePeriodTimeline(durationUs, true, false, false, null, "tag"));
    }
