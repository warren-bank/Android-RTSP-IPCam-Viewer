...
/**
 * Stores RTSP headers and provides methods to modify the headers in a thread safe way to avoid the
 * potential of creating snapshots of an inconsistent or unintended state.
 */
public final class Headers {
    ...
    /**
     * Added a specified header {@code value} for the specified {@code name}. If a header for this
     * name previously existed, the old value is replaced by the specified value.
     *
    ...
    /**
     * Sets the keys and values contained in the map. If a header previously existed, the old value
     * is replaced by the specified value. If a header previously existed and is not in the map, the
