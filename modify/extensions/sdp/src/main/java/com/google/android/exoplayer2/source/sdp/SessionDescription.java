...
/**
 * Represents the data defined by the MediaSession Description Protocol (see IETF RFC 4566) and
 * holds information about the originator of a session, the media types that a client can support
 * and the host and port on which the client will listen for that media.
 *
 * The SessionDescription also holds timing information for the session (e.g. start, end, repeat,
