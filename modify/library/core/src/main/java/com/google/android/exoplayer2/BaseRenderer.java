...
public abstract class BaseRenderer implements Renderer, RendererCapabilities {
     ...
     * {@link #onEnabled(boolean)} has been called, and also when the stream has been replaced
     * whilst the renderer is enabled or started.
     * <p>
     * The default implementation is a no-op.
     *
     * @param formats  The enabled formats.
     * @param offsetUs The offset that will be added to the timestamps of buffers read via {@link
     *                 #readSource(FormatHolder, DecoderInputBuffer, boolean)} so that decoder input
    ...
    /**
     * Creates an {@link ExoPlaybackException} of type {@link ExoPlaybackException#TYPE_RENDERER}
     * for this renderer.
     *
