...
public final class C {
    ...
    /**
     * Crypto modes for a codec. One of {@link #CRYPTO_MODE_UNENCRYPTED}, {@link
     * #CRYPTO_MODE_AES_CTR} or {@link #CRYPTO_MODE_AES_CBC}.
     */
    @Documented
    ...
    /**
     * Represents a PCM audio encoding, or an invalid or unset value. One of {@link
     * Format#NO_VALUE}, {@link #ENCODING_INVALID}, {@link #ENCODING_PCM_8BIT}, {@link
     * #ENCODING_PCM_16BIT}, {@link #ENCODING_PCM_24BIT}, {@link #ENCODING_PCM_32BIT}, {@link
     * #ENCODING_PCM_FLOAT}, {@link #ENCODING_PCM_MU_LAW} or {@link #ENCODING_PCM_A_LAW}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({
     ...
     *
     * <p>Note that {@code FLAG_HW_AV_SYNC} is not available because the player takes care of
     * setting
     ...
     * #USAGE_ALARM}, {@link #USAGE_ASSISTANCE_ACCESSIBILITY}, {@link #USAGE_ASSISTANCE_NAVIGATION_GUIDANCE},
     * {@link #USAGE_ASSISTANCE_SONIFICATION}, {@link #USAGE_ASSISTANT}, {@link #USAGE_GAME}, {@link
     * #USAGE_MEDIA}, {@link #USAGE_NOTIFICATION}, {@link #USAGE_NOTIFICATION_COMMUNICATION_DELAYED},
     * {@link #USAGE_NOTIFICATION_COMMUNICATION_INSTANT}, {@link #USAGE_NOTIFICATION_COMMUNICATION_REQUEST},
     * {@link #USAGE_NOTIFICATION_EVENT}, {@link #USAGE_NOTIFICATION_RINGTONE}, {@link
     * #USAGE_UNKNOWN}, {@link #USAGE_VOICE_COMMUNICATION} or {@link #USAGE_VOICE_COMMUNICATION_SIGNALLING}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({
    ...
    /**
     * Capture policies for {@link com.google.android.exoplayer2.audio.AudioAttributes}. One of
     * {@link #ALLOW_CAPTURE_BY_ALL}, {@link #ALLOW_CAPTURE_BY_NONE} or {@link
     ...
     * #BUFFER_FLAG_KEY_FRAME}, {@link #BUFFER_FLAG_END_OF_STREAM}, {@link
     * #BUFFER_FLAG_LAST_SAMPLE}, {@link #BUFFER_FLAG_ENCRYPTED} and {@link
     ...
     * ExoPlayer#createMessage(Target)}. The message payload should be the target {@link Surface},
     * or null.
     */
     ...
     *
     * <p>To get audio attributes that are equivalent to a legacy stream type, pass the stream type
     * to
     ...
     *
     * <p>Note that the scaling mode only applies if the {@link Surface} targeted by the renderer
     * is
     ...
     * VideoDecoderOutputBufferRenderer}. For other use cases, an output surface should be passed
     * via {@link #MSG_SET_SURFACE} instead.
     */
     ...
     * #STEREO_MODE_MONO}, {@link #STEREO_MODE_TOP_BOTTOM}, {@link #STEREO_MODE_LEFT_RIGHT} or
     * {@link #STEREO_MODE_STEREO_MESH}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({
     ...
     * #ROLE_FLAG_ALTERNATE}, {@link #ROLE_FLAG_SUPPLEMENTARY}, {@link #ROLE_FLAG_COMMENTARY},
     * {@link #ROLE_FLAG_DUB}, {@link #ROLE_FLAG_EMERGENCY}, {@link #ROLE_FLAG_CAPTION}, {@link
