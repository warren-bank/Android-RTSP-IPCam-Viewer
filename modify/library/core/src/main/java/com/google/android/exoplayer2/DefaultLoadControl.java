...
public class DefaultLoadControl implements LoadControl {
     ...
     * all times, in milliseconds. This value is only applied to playbacks without video.
     */
    public static final int DEFAULT_MIN_BUFFER_MS = 15000;

    /**
     * The default maximum duration of media that the player will attempt to buffer, in
     * milliseconds. For playbacks with video, this is also the default minimum duration of media
     * that the player will attempt to ensure is buffered.
     */
    ...
    /**
     * The default target buffer size in bytes. The value ({@link C#LENGTH_UNSET}) means that the
     * load control will calculate the target buffer size based on the selected tracks.
     */
    ...
    public static final class Builder {
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been
         *                               called.
         */
         ...
         *
         * @param minBufferMs                      The minimum duration of media that the player
         *                                         will attempt to ensure is buffered at all times,
         *                                         in milliseconds.
         * @param maxBufferMs                      The maximum duration of media that the player
         *                                         will attempt to buffer, in milliseconds.
         * @param bufferForPlaybackMs              The duration of media that must be buffered for
         *                                         playback to start or resume following a user
         *                                         action such as a seek, in milliseconds.
         * @param bufferForPlaybackAfterRebufferMs The default duration of media that must be
         *                                         buffered for playback to resume after a rebuffer,
         *                                         in milliseconds. A rebuffer is defined to be
         *                                         caused by buffer depletion rather than a user
         *                                         action.
         * @return This builder, for convenience.
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been
         *                               called.
    ...
    /**
     * Calculate target buffer size in bytes based on the selected tracks. The player will try not
     * to exceed this target buffer. Only used when {@code targetBufferBytes} is {@link
     * C#LENGTH_UNSET}.
     *
