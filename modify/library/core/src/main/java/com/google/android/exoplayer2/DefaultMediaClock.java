...
/* package */ final class DefaultMediaClock implements MediaClock {
    ...
    /**
     * Creates a new instance with listener for playback parameter changes and a {@link Clock} to
    ...
    /**
     * Notifies the media clock that a renderer has been enabled. Starts using the media clock of
     * the provided renderer if available.
     *
     * @param renderer The renderer which has been enabled.
     * @throws ExoPlaybackException If the renderer provides a media clock and another renderer
     *                              media clock is already provided.
     */
    ...
    /**
     * Notifies the media clock that a renderer has been disabled. Stops using the media clock of
     * this renderer if used.
     *
