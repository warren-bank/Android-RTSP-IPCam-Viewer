...
public class DefaultRenderersFactory implements RenderersFactory {
    ...
    /**
     * Allow use of extension renderers. Extension renderers are indexed before core renderers of
     * the same type. A {@link TrackSelector} that prefers the first suitable renderer will
     * therefore prefer to use an extension renderer to a core renderer in the case that both are
     * able to play a given track.
     */
    ...
    /**
     * @deprecated Use {@link #DefaultRenderersFactory(Context)}, {@link #setExtensionRendererMode(int)}
     * and {@link #setAllowedVideoJoiningTimeMs(long)}.
     */
    @Deprecated
    @SuppressWarnings("deprecation")
    public DefaultRenderersFactory(
     ...
     * to {@link SimpleExoPlayer.Builder}.
     */
    @Deprecated
    public DefaultRenderersFactory(
            Context context,
    ...
    /**
     * Sets the extension renderer mode, which determines if and how available extension renderers
     * are used. Note that extensions must be included in the application build for them to be
     ...
     * obtained the keys necessary to decrypt encrypted regions of the media. For encrypted media
     * that starts with a short clear region, this allows playback to begin in parallel with key
     ...
     *                                    encrypted media prior to having obtained the keys
     ...
     * This may result in using a decoder that is less efficient or slower than the primary
     * decoder.
     *
     ...
     *                                  to seamlessly join an ongoing playback, in milliseconds.
     * @return This factory, for convenience.
     */
     ...
     * @param drmSessionManager           An optional {@link DrmSessionManager}. May be null if the
     *                                    player will not be used for DRM protected playbacks.
     * @param playClearSamplesWithoutKeys Whether renderers are permitted to play clear regions of
     *                                    encrypted media prior to having obtained the keys
     *                                    necessary to decrypt encrypted regions of the media.
     ...
     *                                    decoder that is slower/less efficient than the primary
     *                                    decoder.
     * @param audioProcessors             An array of {@link AudioProcessor}s that will process PCM
     *                                    audio buffers before output. May be empty.
     * @param eventHandler                A handler to use when invoking event listeners and
     *                                    outputs.
     * @param eventListener               An event listener.
     * @param out                         An array to which the built renderers should be appended.
     */
     ...
     * @param outputLooper          The looper associated with the thread on which the output should
     *                              be called.
     * @param extensionRendererMode The extension renderer mode.
     * @param out                   An array to which the built renderers should be appended.
     */
