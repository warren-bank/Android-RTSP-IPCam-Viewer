...
public final class ExoPlaybackException extends Exception {
    ...
    /**
     * The type of source that produced the error. One of {@link #TYPE_SOURCE}, {@link
     * #TYPE_RENDERER} {@link #TYPE_UNEXPECTED}, {@link #TYPE_REMOTE} or {@link
     * #TYPE_OUT_OF_MEMORY}. Note that new types may be added in the future and error handling
     * should handle unknown type values.
     */
    @Documented
     ...
     * @param rendererFormat        The {@link Format} the renderer was using at the time of the
     *                              exception, or null if the renderer wasn't using a {@link
     *                              Format}.
