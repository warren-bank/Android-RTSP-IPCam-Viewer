...
public final class Format implements Parcelable {
     ...
     * acquire a {@link DrmSession} for {@link #drmInitData}. Null if the media source cannot
     * acquire a session for {@link #drmInitData}, or if not applicable.
     */
    @Nullable
    ...
    /**
     * @deprecated Use {@link #createContainerFormat(String, String, String, String, String, int,
    ...
    /**
     * Returns the number of pixels if this is a video format whose {@link #width} and {@link
     * #height} are known, or {@link #NO_VALUE} otherwise
     */
