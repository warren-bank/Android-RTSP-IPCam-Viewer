...
public interface LoadControl {
    ...
    /**
     * Returns whether media should be retained from the keyframe before the current playback
     * position minus {@link #getBackBufferDurationUs()}, rather than any sample before or at that
     * position.
     * <p>
     ...
     * not currently supported.
     *
     * @return Whether media should be retained from the keyframe before the current playback
     * position minus {@link #getBackBufferDurationUs()}, rather than any sample before or at that
     * position.
     */
     ...
     * @param bufferedDurationUs The duration of media that's currently buffered.
     * @param playbackSpeed      The current playback speed.
     * @param rebuffering        Whether the player is rebuffering. A rebuffer is defined to be
     *                           caused by buffer depletion rather than a user action. Hence this
     *                           parameter is false during initial buffering and when buffering as a
