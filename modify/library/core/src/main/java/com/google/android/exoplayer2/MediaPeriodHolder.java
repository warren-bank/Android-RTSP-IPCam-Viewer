...
/* package */ final class MediaPeriodHolder {
     ...
     * @param rendererPositionOffsetUs The renderer time of the start of the period, in
     *                                 microseconds.
    ...
    /**
     * Converts time relative to the start of the period to the respective renderer time using
     * {@link #getRendererOffset()}, in microseconds.
     */
    ...
    /**
     * Converts renderer time to the respective time relative to the start of the period using
     * {@link #getRendererOffset()}, in microseconds.
     */
    ...
    /**
     * Returns the next load time relative to the start of the period, or {@link
     ...
     * @param positionUs           The position relative to the start of the period at which to
     *                             apply the new track selections, in microseconds.
     ...
     *                               apply the new track selections, in microseconds.
     * @param forceRecreateStreams   Whether all streams are forced to be recreated.
     * @param streamResetFlags       Will be populated to indicate which streams have been reset or
     *                               were newly created.
     * @return The actual position relative to the start of the period at which the new track
     * selections are applied.
     */
    ...
    /**
     * For each renderer of type {@link C#TRACK_TYPE_NONE} that was enabled, we will associate it
     * with a dummy {@link EmptySampleStream}.
     */
