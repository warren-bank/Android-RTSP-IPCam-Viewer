...
/* package */ final class MediaPeriodQueue {
     ...
     * buffering policy normally prevents buffering too far ahead, but the policy could allow too
     * many small periods to be buffered if the period count were not limited.
     */
    ...
    /**
     * Sets the {@link RepeatMode} and returns whether the repeat mode change has been fully
    ...
    /**
     * Enqueues a new media period holder based on the specified information as the new loading
     * media period, and returns it.
     *
     * @param rendererCapabilities     The renderer capabilities.
     * @param trackSelector            The track selector.
     * @param allocator                The allocator.
     * @param mediaSource              The media source that produced the media period.
     * @param info                     Information used to identify this media period in its
     *                                 timeline period.
     ...
     * period holder to be the next item in the queue.
     *
     ...
     * Clears the queue.
     *
     * @param keepFrontPeriodUid Whether the queue should keep the id of the media period in the
     *                           front of queue (typically the playing one) for later reuse.
     */
     ...
     * current playback position. The method assumes that the first media period in the queue is
     * still consistent with the new timeline.
     *
     * @param rendererPositionUs        The current renderer position in microseconds.
     * @param maxRendererReadPositionUs The maximum renderer position up to which renderers have
     *                                  read the current reading media period in microseconds, or
     *                                  {@link C#TIME_END_OF_SOURCE} if they have read to the end.
     ...
     * played, returning an identifier for an ad group if one needs to be played before the
     * specified position, or an identifier for a content media period if not.
     *
    ...
    /**
     * Resolves the specified period uid to a corresponding window sequence number. Either by
    ...
    /**
     * Returns whether a period described by {@code oldInfo} can be kept for playing the media
     * period described by {@code newInfo}.
     */
    ...
    /**
     * Returns whether a duration change of a period is compatible with keeping the following
     * periods.
     */
    ...
    /**
     * Returns the {@link MediaPeriodInfo} for the media period following {@code
     * mediaPeriodHolder}'s media period.
     *
     * @param mediaPeriodHolder  The media period holder.
     * @param rendererPositionUs The current renderer position in microseconds.
     * @return The following media period's info, or {@code null} if it is not yet possible to get
     * the next media period info.
     */
    private @Nullable
