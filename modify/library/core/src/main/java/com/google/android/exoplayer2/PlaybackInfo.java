...
/* package */ final class PlaybackInfo {
     ...
     * is used when playback infos are created with {@link #createDummy(long,
     * TrackSelectorResult)}.
     */
    ...
    /**
     * The start position at which playback started in {@link #periodId} relative to the start of
     * the associated period in the {@link #timeline}, in microseconds. Note that this value changes
     * for each position discontinuity.
     */
    public final long startPositionUs;
    /**
     * If {@link #periodId} refers to an ad, the position of the suspended content relative to the
     * start of the associated period in the {@link #timeline}, in microseconds. {@link
     * C#TIME_UNSET} if {@link #periodId} does not refer to an ad or if the suspended content should
     * be played from its default position.
     */
     ...
     * info is available.
     *
     * @param startPositionUs          The start position at which playback should start, in
     *                                 microseconds.
     ...
     * @param contentPositionUs       New content position. See {@link #contentPositionUs}. Value is
     *                                ignored if {@code periodId.isAd()} is true.
