...
public final class PlayerMessage {
    ...
    public interface Target {
         ...
         * @throws ExoPlaybackException If an error occurred whilst handling the message. Should
         *                              only be thrown by targets that handle messages on the
         *                              playback thread.
         */
     ...
     * @param timeline           The timeline used when setting the position with {@link
     *                           #setPosition(long)}. If set to {@link Timeline#EMPTY}, any position
     *                           can be specified.
     * @param defaultWindowIndex The default window index in the {@code timeline} when no other
     *                           window index is specified.
    ...
    /**
     * Returns position in window at {@link #getWindowIndex()} at which the message will be
     * delivered, in milliseconds. If {@link C#TIME_UNSET}, the message will be delivered
     * immediately.
     */
     ...
     * @return This message.
     * @throws IllegalSeekPositionException If the timeline returned by {@link #getTimeline()} is
     *                                      not empty and the provided window index is not within
     ...
     * if playback reaches the specified position again. Only allowed to be false if a position is
     * set with {@link #setPosition(long)}.
     *
     ...
     * out of the player as an error using {@link Player.EventListener#onPlayerError(ExoPlaybackException)}.
     *
     * @return This message.
     ...
     * the message.
     *
     * <p>Note that this method can't be called if the current thread is the same thread used by
     * the
     ...
     *                    considered as being delivered when this method has been called with {@code
     *                    isDelivered} set to true at least once.
     */
