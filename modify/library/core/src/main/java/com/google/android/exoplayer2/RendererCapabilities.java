...
public interface RendererCapabilities {
     ...
     * but is not capable of rendering the format or any other format with the same mime type
     * because the sub-type is not supported.
     * <p>
     * Example: The {@link Renderer} is a general purpose audio renderer and the format's mime type
     ...
     * {@link #getTunnelingSupport(int)} to obtain the individual flags. And use {@link
     * #create(int)} or {@link #create(int, int, int)} to create the combined capabilities.
     *
     * <p>Possible values:
     *
     * <ul>
     ...
     * #ADAPTIVE_NOT_SEAMLESS} and {@link #ADAPTIVE_NOT_SUPPORTED}. Only set if the level of support
     * for the format itself is {@link #FORMAT_HANDLED} or {@link #FORMAT_EXCEEDS_CAPABILITIES}.
     * <li>{@link TunnelingSupport}: The level of support for tunneling. One of {@link
     * #TUNNELING_SUPPORTED} and {@link #TUNNELING_NOT_SUPPORTED}. Only set if the level of support
     * for the format itself is {@link #FORMAT_HANDLED} or {@link #FORMAT_EXCEEDS_CAPABILITIES}.
     * </ul>
     */
    @Documented
    ...
    /**
     * Returns {@link Capabilities} combining the given {@link FormatSupport}, {@link
     ...
     *
     * @return The {@link AdaptiveSupport} for adapting between supported formats that have
