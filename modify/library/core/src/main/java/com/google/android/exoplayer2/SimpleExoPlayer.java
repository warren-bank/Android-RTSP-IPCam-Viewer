...
public class SimpleExoPlayer extends BasePlayer
    ...
    public static final class Builder {
         ...
         * Creates a builder.
         *
         * <p>Use {@link #Builder(Context, RenderersFactory)} instead, if you intend to provide a
         * custom
         * {@link RenderersFactory}. This is to ensure that ProGuard or R8 can remove ExoPlayer's
         * {@link DefaultRenderersFactory} from the APK.
         *
         ...
         *
         * @param context          A {@link Context}.
         * @param renderersFactory A factory for creating {@link Renderer Renderers} to be used by
         *                         the player.
         */
    ...
    /**
     * @param context            A {@link Context}.
     * @param renderersFactory   A factory for creating {@link Renderer}s to be used by the
     *                           instance.
     ...
     * @param clock              The {@link Clock} that will be used by the instance. Should always
     *                           be {@link Clock#DEFAULT}, unless the player is being used from a
     *                           test.
     * @param looper             The {@link Looper} which must be used for all calls to the player
     *                           and which is used to call listeners on.
     */
     ...
     * @param looper             The {@link Looper} which must be used for all calls to the player
     *                           and which is used to call listeners on.
     * @deprecated Use {@link #SimpleExoPlayer(Context, RenderersFactory, TrackSelector,
     * LoadControl, BandwidthMeter, AnalyticsCollector, Clock, Looper)} instead, and pass the {@link
     ...
     * playback can occur when the screen is off (e.g. background audio playback). It is not useful
     * if the screen will always be on during playback (e.g. foreground video playback).
     *
     * <p>This feature is not enabled by default. If enabled, a WakeLock is held whenever the
     * player
