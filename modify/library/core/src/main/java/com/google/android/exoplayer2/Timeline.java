 ...
 * window and the default position, which is the position from which playback will start when the
 * player starts playing the window.
 * <li>A {@link Period} defines a single logical piece of media, for example a media file. It may
 * also define groups of ads inserted into the media, along with information about whether those ads
 * have been loaded and played.
 * </ul>
 *
 ...
 *
 * <p align="center"><img src="doc-files/timeline-playlist.svg" alt="Example timeline for a
 * playlist
 ...
 *
 * <p align="center"><img src="doc-files/timeline-live-limited.svg" alt="Example timeline for a
 * live
 ...
 *
 * <p align="center"><img src="doc-files/timeline-live-multi-period.svg" alt="Example timeline for
 * a
...
public abstract class Timeline {
     ...
     * additional information such as whether seeking is supported within the window. The figure
     * below shows some of the information defined by a window, as well as how this information
     * relates to corresponding {@link Period Periods} in the timeline.
     *
    ...
    public static final class Window {
        ...
        /**
         * A {@link #uid} for a window that must be used for single-window {@link Timeline
         * Timelines}.
         */
        public static final Object SINGLE_WINDOW_UID = new Object();

        /**
         * A unique identifier for the window. Single-window {@link Timeline Timelines} must use
         * {@link #SINGLE_WINDOW_UID}.
         */
        public Object uid;
         ...
         * epoch, or {@link C#TIME_UNSET} if unknown or not applicable. For informational purposes
         * only.
         */
        public long presentationStartTimeMs;

        /**
         * The window's start time in milliseconds since the epoch, or {@link C#TIME_UNSET} if
        ...
        /**
         * Returns the default position relative to the start of the window at which to begin
         * playback, in milliseconds. May be {@link C#TIME_UNSET} if and only if the window was
         * populated with a non-zero default position projection, and if the specified projection
         * cannot be performed whilst remaining within the bounds of the window.
         */
        ...
        /**
         * Returns the default position relative to the start of the window at which to begin
         * playback, in microseconds. May be {@link C#TIME_UNSET} if and only if the window was
         * populated with a non-zero default position projection, and if the specified projection
         * cannot be performed whilst remaining within the bounds of the window.
         */
        ...
        /**
         * Returns the position of the start of this window relative to the start of the first
         * period belonging to it, in milliseconds.
         */
     ...
     * piece of media, for example a media file. It may also define groups of ads inserted into the
     * media, along with information about whether those ads have been loaded and played.
     * <p>
    ...
    public static final class Period {
        ...
        /**
         * An identifier for the period. Not necessarily unique. May be null if the ids of the
        ...
        /**
         * A unique identifier for the period. May be null if the ids of the period are not
         * required.
         */
        @Nullable
        public Object uid;
         ...
         *
         * @param id                 An identifier for the period. Not necessarily unique. May be
         *                           null if the ids of the period are not required.
         * @param uid                A unique identifier for the period. May be null if the ids of
         *                           the period are not required.
         * @param windowIndex        The index of the window to which this period belongs.
         * @param durationUs         The duration of this period in microseconds, or {@link
         *                           C#TIME_UNSET} if unknown.
         * @param positionInWindowUs The position of the start of this period relative to the start
         *                           of the window to which it belongs, in milliseconds. May be
         *                           negative if the start of the period is not within the window.
         ...
         *                           of the window to which it belongs, in milliseconds. May be
         *                           negative if the start of the period is not within the window.
         * @param adPlaybackState    The state of the period's ads, or {@link AdPlaybackState#NONE}
         *                           if there are no ads.
         * @return This period, for convenience.
         */
        public Period set(
        ...
        /**
         * Returns the position of the start of this period relative to the start of the window to
         * which it belongs, in milliseconds. May be negative if the start of the period is not
         * within the window.
         */
        ...
        /**
         * Returns the position of the start of this period relative to the start of the window to
         * which it belongs, in microseconds. May be negative if the start of the period is not
         * within the window.
         */
         ...
         *
         * @param adGroupIndex The ad group index.
         * @return The index of the first ad that should be played, or the number of ads in the ad
         * group if no ads should be played.
         */
         ...
         * playing {@code adIndexInAdGroup}, or the number of ads in the ad group if no later ads
         * should be played.
         *
         * @param adGroupIndex      The ad group index.
         * @param lastPlayedAdIndex The last played ad index in the ad group.
         * @return The index of the next ad that should be played, or the number of ads in the ad
         * group if the ad group does not have any ads remaining to play.
         */
         ...
         * unplayed. Returns {@link C#INDEX_UNSET} if the ad group at or before {@code positionUs}
         * has no ads remaining to be played, or if there is no such ad group.
         *
        ...
        /**
         * Returns the index of the next ad group after {@code positionUs} that has ads remaining to
         * be played. Returns {@link C#INDEX_UNSET} if there is no such ad group.
         *
    ...
    /**
     * Returns the index of the window after the window at index {@code windowIndex} depending on
     * the {@code repeatMode} and whether shuffling is enabled.
     *
    ...
    /**
     * Returns the index of the window before the window at index {@code windowIndex} depending on
     * the {@code repeatMode} and whether shuffling is enabled.
     *
     * @param windowIndex        Index of a window in the timeline.
     * @param repeatMode         A repeat mode.
     * @param shuffleModeEnabled Whether shuffling is enabled.
     * @return The index of the previous window, or {@link C#INDEX_UNSET} if this is the first
     * window.
     */
    ...
    /**
     * Returns the index of the period after the period at index {@code periodIndex} depending on
     * the {@code repeatMode} and whether shuffling is enabled.
     *
    ...
    /**
     * Calls {@link #getPeriodPosition(Window, Period, int, long, long)} with a zero default
     * position projection.
     */
     ...
     * @param windowPositionUs            The window time, or {@link C#TIME_UNSET} to use the
     *                                    window's default start position.
     ...
     * @param periodIndex The index of the period.
     * @param period      The {@link Period} to populate. Must not be null.
     * @param setIds      Whether {@link Period#id} and {@link Period#uid} should be populated. If
     *                    false, the fields will be set to null. The caller should pass false for
     *                    efficiency reasons unless the fields are required.
     * @return The populated {@link Period}, for convenience.
     */
