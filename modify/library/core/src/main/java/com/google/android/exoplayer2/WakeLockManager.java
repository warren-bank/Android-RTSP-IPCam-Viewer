...
/* package */ final class WakeLockManager {
     ...
     *
     * <p>By default, wake lock handling is not enabled. Enabling this will acquire the wake lock
     * if
     ...
     *
     * <p>Please note this method requires wake lock handling to be enabled through
     * setEnabled(boolean
