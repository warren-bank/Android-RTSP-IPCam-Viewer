...
public class AnalyticsCollector
    ...
    /**
     * Sets the player for which data will be collected. Must only be called if no player has been
     * set yet or the current player is idle.
     *
    ...
    /**
     * Notify analytics collector that a seek operation will start. Should be called before the
    ...
    private static final class MediaPeriodQueueTracker {
        ...
        /**
         * Returns the {@link MediaPeriodInfo} of the media period in the front of the queue. This
         * is the playing media period unless the player hasn't started playing yet (in which case
         * it is the loading media period or null). While the player is seeking or preparing, this
         * method will always return null to reflect the uncertainty about the current playing
         * period. May also be null, if the timeline is empty or no media period is active yet.
         */
        @Nullable
         ...
         * unless the player is currently seeking or being prepared in which case the previous
         * period is reported until the seek or preparation is processed. May be null, if no media
         * period is active yet.
         */
        @Nullable
        ...
        /**
         * Returns the {@link MediaPeriodInfo} of the media period currently being read by the
         ...
         * currently loading or will be the next one loading. May be null, if no media period is
         * active yet.
         */
        @Nullable
        ...
        /**
         * Tries to find an existing media period info from the specified window index. Only returns
         * a non-null media period info if there is a unique, unambiguous match.
         */
        @Nullable
        ...
        /**
         * Updates the queue with a released media period. Returns whether the media period was
         * still in the queue.
         */
    ...
    private static final class MediaPeriodInfo {
        ...
        /**
         * The {@link Timeline} in which the media period can be found. Or {@link Timeline#EMPTY} if
         * the media period is not part of a known timeline yet.
         */
        public final Timeline timeline;
        /**
         * The window index of the media period in the timeline. If the timeline is empty, this is
         * the prospective window index.
         */
