...
public interface PlaybackSessionManager {
    ...
    interface Listener {
         ...
         *
         * @param eventTime                         The {@link EventTime} at which the session
         *                                          finished.
         * @param sessionId                         The identifier of the finished session.
         * @param automaticTransitionToNextPlayback Whether the session finished because of an
         *                                          automatic transition to the next playback item.
         */
    ...
    /**
     * Sets the listener to be notified of session updates. Must be called before the session
     * manager is used.
     *
     ...
     *
     * <p>Note that this will reserve a new session identifier if it doesn't exist yet, but will
     * not
