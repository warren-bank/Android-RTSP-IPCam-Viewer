...
public final class PlaybackStatsListener
    ...
    public interface Callback {
         ...
         *
         * @param eventTime     The {@link EventTime} at which the playback session started. Can be
         *                      used to identify the playback session.
    ...
    /**
     * Returns the {@link PlaybackStats} for the currently playback session, or null if no session
     * is active.
     *
    ...
    /**
     * Finishes all pending playback sessions. Should be called when the listener is removed from
     * the player or when the player is released.
     */
    ...
    private static final class PlaybackStatsTracker {
        ...
        /**
         * Notifies the tracker of a player state change event, including all player state changes
        ...
        /**
         * Notifies the tracker of a change to the playback suppression (e.g. due to audio focus
         * loss), including all updates while the playback is not in the foreground.
         *
         * @param eventTime         The {@link EventTime}.
        ...
        /**
         * Notifies the tracker of a position discontinuity or timeline update for the current
         * playback.
         *
         * @param eventTime The {@link EventTime}.
         */
         ...
         *
         * @param eventTime The {@link EventTime}. Not guaranteed to belong to the current
         *                  playback.
         */
        ...
        /**
         * Notifies the tracker of a playback speed change, including all playback speed changes
         * while the playback is not in the foreground.
         *
         * @param eventTime     The {@link EventTime}.
         ...
         *
         * @param timeMs The time for which bandwidth measurement data is available, in
         *               milliseconds.
