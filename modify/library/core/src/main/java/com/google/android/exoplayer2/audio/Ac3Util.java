...
public final class Ac3Util {
    ...
    public static final class SyncFrameInfo {
        ...
        /**
         * AC3 stream types. See also ETSI TS 102 366 E.1.3.1.1. One of {@link
         * #STREAM_TYPE_UNDEFINED}, {@link #STREAM_TYPE_TYPE0}, {@link #STREAM_TYPE_TYPE1} or {@link
         * #STREAM_TYPE_TYPE2}.
         */
        @Documented
    ...
    /**
     * The number of samples to store in each output chunk when rechunking TrueHD streams. The
     * number of samples extracted from the container corresponding to one syncframe must be an
     * integer multiple of this value.
     */
    public static final int TRUEHD_RECHUNK_SAMPLE_COUNT = 16;
    /**
     * The number of bytes that must be parsed from a TrueHD syncframe to calculate the sample
     * count.
     */
    ...
    /**
     * Returns the E-AC-3 format given {@code data} containing the EC3SpecificBox according to ETSI
     * TS 102 366 Annex F. The reading position of {@code data} will be modified.
     *
