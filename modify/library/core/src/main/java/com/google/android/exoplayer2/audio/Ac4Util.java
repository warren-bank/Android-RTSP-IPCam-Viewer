...
public final class Ac4Util {
     ...
     * provides the number of samples per frame at the playback sampling frequency of 48 kHz. For
     * 44.1 kHz, only frame_rate_index(13) is valid and corresponding sample count is 2048.
     */
