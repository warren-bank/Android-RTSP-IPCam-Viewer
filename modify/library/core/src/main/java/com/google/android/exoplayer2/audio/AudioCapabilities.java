...
public final class AudioCapabilities {
    ...
    /**
     * Returns the global settings {@link Uri} used by the device to specify external surround
     * sound, or null if the device does not support this functionality.
     */
    @Nullable
     ...
     * count.
     *
     * <p>Applications should generally call {@link #getCapabilities(Context)} to obtain an
     * instance
     ...
     *                           {@code ENCODING_*} constants. Passing {@code null} indicates that
     *                           no encodings are supported.
     * @param maxChannelCount    The maximum number of audio channels that can be played
     *                           simultaneously.
     */
