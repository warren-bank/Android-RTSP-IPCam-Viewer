...
public final class AuxEffectInfo {
     ...
     *                  AudioEffect#getId()} on the effect, or {@value NO_AUX_EFFECT_ID} which
     *                  represents no effect. This value is passed to {@link
     ...
     *                  is full send. If {@code effectId} is not {@value #NO_AUX_EFFECT_ID}, this
     *                  value is passed to {@link AudioTrack#setAuxEffectSendLevel(float)} on the
