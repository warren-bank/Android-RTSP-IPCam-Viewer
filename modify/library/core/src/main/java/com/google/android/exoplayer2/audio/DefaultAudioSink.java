...
public final class DefaultAudioSink implements AudioSink {
     ...
     * audio processors followed by {@link SilenceSkippingAudioProcessor} and {@link
     * SonicAudioProcessor}.
     */
     ...
     *
     * @param audioCapabilities                 The audio capabilities for playback on this device.
     *                                          May be null if the default capabilities (no encoded
     *                                          audio passthrough support) should be assumed.
     * @param audioProcessors                   An array of {@link AudioProcessor}s that will
     *                                          process PCM audio before output. May be empty.
     * @param enableConvertHighResIntPcmToFloat Whether to enable conversion of high resolution
     *                                          integer PCM to 32-bit float for output, if possible.
     *                                          Functionality that uses 16-bit integer audio
     *                                          processing (for example, speed and pitch adjustment)
     *                                          will not be available when float output is in use.
     */
    public DefaultAudioSink(
     ...
     *                                          May be null if the default capabilities (no encoded
     *                                          audio passthrough support) should be assumed.
     * @param audioProcessorChain               An {@link AudioProcessorChain} which is used to
     *                                          apply playback parameters adjustments. The instance
     *                                          passed in must not be reused in other sinks.
     * @param enableConvertHighResIntPcmToFloat Whether to enable conversion of high resolution
     *                                          integer PCM to 32-bit float for output, if possible.
     *                                          Functionality that uses 16-bit integer audio
     *                                          processing (for example, speed and pitch adjustment)
