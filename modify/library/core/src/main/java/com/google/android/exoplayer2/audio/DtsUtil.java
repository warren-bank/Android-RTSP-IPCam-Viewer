...
public final class DtsUtil {
    ...
    /**
     * Returns whether a given integer matches a DTS sync word. Synchronization and storage modes
     * are defined in ETSI TS 102 114 V1.1.1 (2002-08), Section 5.3.
     *
    ...
    /**
     * Returns the DTS format given {@code data} containing the DTS frame according to ETSI TS 102
     * 114 subsections 5.3/5.4.
     *
