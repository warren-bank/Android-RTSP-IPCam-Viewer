...
public final class SilenceSkippingAudioProcessor extends BaseAudioProcessor {
    ...
    /**
     * The duration of silence by which to extend non-silent sections, in microseconds. The value
     * must not exceed {@link #MINIMUM_SILENCE_DURATION_US}.
     */
     ...
     * the input becomes noisy before the buffer has filled, it will be output. Otherwise, the
     * buffer contents will be dropped and the state will transition to {@link #STATE_SILENT}.
     */
     ...
     * through the processor. The value returned by {@link #isActive()} may change, and the
    ...
    /**
     * Returns the total number of frames of input audio that were skipped due to being classified
     * as silence since the last call to {@link #flush()}.
     */
     ...
     * at the end of {@code buffer} (up to its {@code size}) required to fill it, advancing the
     * input position.
     */
    ...
    /**
     * Returns the number of input frames corresponding to {@code durationUs} microseconds of
     * audio.
     */
    ...
    /**
     * Returns the earliest byte position in [position, limit) of {@code buffer} that contains a
     * frame classified as a noisy frame, or the limit of the buffer if no such frame exists.
     */
    ...
    /**
     * Returns the earliest byte position in [position, limit) of {@code buffer} such that all
     * frames from the byte position to the limit are classified as silent.
     */
