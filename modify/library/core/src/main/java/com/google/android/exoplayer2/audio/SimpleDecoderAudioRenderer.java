...
public abstract class SimpleDecoderAudioRenderer extends BaseRenderer implements MediaClock {
    ...
    /**
     * The input format has changed in a way that requires the decoder to be re-initialized, and
     * we've signaled an end of stream to the existing decoder. We're waiting for the decoder to
     * output an end of stream signal to indicate that it has output any remaining buffers before we
     * release it.
     */
     ...
     *                          the default capabilities (no encoded audio passthrough support)
     *                          should be assumed.
     */
    public SimpleDecoderAudioRenderer(
            @Nullable Handler eventHandler,
     ...
     * @param drmSessionManager           For use with encrypted media. May be null if support for
     ...
     *                                    media.
     * @param audioProcessors             Optional {@link AudioProcessor}s that will process audio
     *                                    before output.
     */
    public SimpleDecoderAudioRenderer(
            @Nullable Handler eventHandler,
     ...
     *                    Maybe null and can be ignored if decoder does not handle encrypted
     *                    content.
     * @return The decoder.
