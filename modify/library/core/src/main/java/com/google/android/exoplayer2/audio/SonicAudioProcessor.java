...
public final class SonicAudioProcessor implements AudioProcessor {
    ...
    /**
     * Sets the sample rate for output audio, in Hertz. Pass {@link #SAMPLE_RATE_NO_CHANGE} to
     * output audio at the same sample rate as the input. After calling this method, call {@link
    ...
    /**
     * Returns the specified duration scaled to take into account the speedup factor of this
     * instance, in the same units as {@code duration}.
     *
