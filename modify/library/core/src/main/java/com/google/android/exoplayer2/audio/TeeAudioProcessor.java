...
public final class TeeAudioProcessor extends BaseAudioProcessor {
    ...
    /**
     * Creates a new tee audio processor, sending incoming data to the given {@link
     * AudioBufferSink}.
     *
     ...
     * When new audio data is handled after flushing the audio processor, a counter is incremented
     * and its value is appended to the output file name.
     *
