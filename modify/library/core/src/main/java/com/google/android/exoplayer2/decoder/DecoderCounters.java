...
public final class DecoderCounters {
     ...
     * <p>
     * Each time buffers to a keyframe are dropped, this counter is increased by one, and the
     * dropped buffer counters are increased by one (for the current output buffer) plus the number
     * of buffers dropped from the source to advance to the keyframe.
     */
    public int droppedToKeyframeCount;

    /**
     * Should be called to ensure counter values are made visible across threads. The playback
     * thread should call this method after updating the counter values. Any other thread should
     * call this method before reading the counters.
     */
