...
public class DecoderInputBuffer extends Buffer {
    ...
    /**
     * @param bufferReplacementMode Determines the behavior of {@link #ensureSpaceForWrite(int)}.
     *                              One of {@link #BUFFER_REPLACEMENT_MODE_DISABLED}, {@link
     *                              #BUFFER_REPLACEMENT_MODE_NORMAL} and {@link
     *                              #BUFFER_REPLACEMENT_MODE_DIRECT}.
     */
     ...
     * current position.
     *
     * <p>If the capacity of {@link #data} is sufficient this method does nothing. If the capacity
     * is
     ...
     *                               the buffer replacement mode of the holder is {@link
     *                               #BUFFER_REPLACEMENT_MODE_DISABLED}.
     */
    @EnsuresNonNull("data")
    ...
    /**
     * Flips {@link #data} and {@link #supplementalData} in preparation for being queued to a
     * decoder.
     *
