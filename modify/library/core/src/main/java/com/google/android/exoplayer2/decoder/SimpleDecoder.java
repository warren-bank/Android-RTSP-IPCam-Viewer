...
public abstract class SimpleDecoder<
    ...
    /**
     * @param inputBuffers  An array of nulls that will be used to store references to input
     *                      buffers.
     * @param outputBuffers An array of nulls that will be used to store references to output
     *                      buffers.
     */
     ...
     *                     C#BUFFER_FLAG_DECODE_ONLY} will be set if the same flag is set on {@code
     *                     inputBuffer}, but may be set/unset as required. If the flag is set when
     *                     the call returns then the output buffer will not be made available to
     *                     dequeue. The output buffer may not have been populated in this case.
