...
@TargetApi(18)
    ...
    public interface ProvisioningManager<T extends ExoMediaCrypto> {
         ...
         * <em>will</em> call {@link DefaultDrmSession#onProvisionCompleted()} when provisioning
         * has
     ...
     *                                offlineLicenseKeySetId} is provided or if {@code
     *                                isPlaceholderSession} is true.
     * @param mode                    The DRM mode. Ignored if {@code isPlaceholderSession} is
     *                                true.
