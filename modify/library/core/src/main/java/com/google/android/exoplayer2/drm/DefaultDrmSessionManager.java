...
public class DefaultDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T> {
    ...
    public static final class Builder {
         ...
         *
         * <p>Users should pass false when a single key request will obtain all keys required to
         * decrypt
         * the associated content. {@code multiSession} is required when content uses key rotation.
         *
         * @param multiSession Whether this session manager is allowed to acquire multiple
        ...
        /**
         * Sets whether this session manager should attach {@link DrmSession DrmSessions} to the
         * clear sections of the media content.
         *
         * <p>Using {@link DrmSession DrmSessions} for clear content avoids the recreation of
         * decoders
         ...
         *                                                and/or {@link C#TRACK_TYPE_VIDEO}) for
         *                                                which to use a {@link DrmSession}
         *                                                regardless of whether the content is clear
         *                                                or encrypted.
         * @return This builder.
         * @throws IllegalArgumentException If {@code useDrmSessionsForClearContentTrackTypes}
         *                                  contains track types other than {@link
         *                                  C#TRACK_TYPE_AUDIO} and {@link C#TRACK_TYPE_VIDEO}.
         */
         ...
         *
         * @param playClearSamplesWithoutKeys Whether clear samples within protected content should
         *                                    be played when keys for the encrypted part of the
         *                                    content have yet to be loaded.
         * @return This builder.
         */
     ...
     *                             {@link ExoMediaDrm#getKeyRequest(byte[], List, int, HashMap)}.
     *                             May be null.
     ...
     *                             {@link ExoMediaDrm#getKeyRequest(byte[], List, int, HashMap)}.
     *                             May be null.
     * @param multiSession         A boolean that specify whether multiple key session support is
     ...
     * @param exoMediaDrm                 An underlying {@link ExoMediaDrm} for use by the manager.
     * @param callback                    Performs key and provisioning requests.
     * @param keyRequestParameters        An optional map of parameters to pass as the last argument
     *                                    to {@link ExoMediaDrm#getKeyRequest(byte[], List, int,
     *                                    HashMap)}. May be null.
     * @param multiSession                A boolean that specify whether multiple key session
     *                                    support is enabled. Default is false.
    ...
    /**
     * Removes a {@link DefaultDrmSessionEventListener} from the list of drm session event
     * listeners.
     *
     ...
     *
     * <ul>
     * <li>{@link #MODE_PLAYBACK}: If {@code offlineLicenseKeySetId} is null, a streaming license
     * is
     ...
     *
     * @param drmInitData      The {@link DrmInitData} from which to extract the {@link
     *                         SchemeData}.
     * @param uuid             The UUID.
