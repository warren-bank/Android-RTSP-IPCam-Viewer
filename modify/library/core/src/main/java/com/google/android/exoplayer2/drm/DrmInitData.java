...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
     ...
     * is true and for which we did not include an entry from the manifest targeting the same UUID.
     * <li>If available, the scheme type from the manifest is used. If not, the scheme type from
     * the
     * media is used.
     * </ol>
     *
    ...
    public static final class SchemeData implements Parcelable {
        ...
        /**
         * @param uuid             The {@link UUID} of the DRM scheme, or {@link C#UUID_NIL} if the
         *                         data is universal (i.e. applies to all schemes).
