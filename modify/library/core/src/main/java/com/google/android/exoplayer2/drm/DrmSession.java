...
public interface DrmSession<T extends ExoMediaCrypto> {
     ...
     * #release()} in that order. Null arguments are ignored. Does nothing if {@code
    ...
    /**
     * Returns a {@link ExoMediaCrypto} for the open session, or null if called before the session
     ...
     * has been opened or after it's been released.
     *
     * <p>Since DRM license policies vary by vendor, the specific status field names are determined
     * by
    ...
    /**
     * Returns the key set id of the offline license loaded into this session, or null if there
     * isn't one.
     */
    @Nullable
