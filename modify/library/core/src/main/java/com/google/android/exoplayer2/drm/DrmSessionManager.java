...
public interface DrmSessionManager<T extends ExoMediaCrypto> {
    ...
    /**
     * Returns a {@link DrmSession} that does not execute key requests, with an incremented
     ...
     * playback of clear content periods. This can reduce the cost of transitioning between clear
     * and encrypted content periods.
     *
     * @param playbackLooper The looper associated with the media playback thread.
     * @param trackType      The type of the track to acquire a placeholder session for. Must be one
     *                       of the {@link C}{@code .TRACK_TYPE_*} constants.
