...
public final class FrameworkMediaDrm implements ExoMediaDrm<FrameworkMediaCrypto> {
     ...
     * UUID. Returns a {@link DummyExoMediaDrm} if the protection scheme identified by the given
     * UUID is not supported by the device.
     */
    ...
    /**
     * Creates an instance with an initial reference count of 1. {@link #release()} must be called
     * on the instance when it's no longer required.
     *
