...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    /**
     * Instantiates a new instance which uses Widevine CDM. Call {@link #release()} when the
     * instance is no longer required.
     *
     * @param defaultLicenseUrl     The default license URL. Used for key requests that do not
     *                              specify their own license URL.
     * @param httpDataSourceFactory A factory from which to obtain {@link HttpDataSource}
     *                              instances.
     ...
     * instance is no longer required.
     *
     * @param defaultLicenseUrl            The default license URL. Used for key requests that do
     *                                     not specify their own license URL.
     * @param forceDefaultLicenseUrl       Whether to use {@code defaultLicenseUrl} for key requests
     *                                     that include their own license URL.
     * @param optionalKeyRequestParameters An optional map of parameters to pass as the last
     *                                     argument to {@link MediaDrm#getKeyRequest}. May be null.
     * @return A new instance which uses Widevine CDM.
     * @throws UnsupportedDrmException If the Widevine DRM scheme is unsupported or cannot be
     *                                 instantiated.
     ...
     *
     * @param drmInitData The {@link DrmInitData} for the content whose license is to be
     *                    downloaded.
