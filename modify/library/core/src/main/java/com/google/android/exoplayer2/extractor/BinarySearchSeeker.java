...
public abstract class BinarySearchSeeker {
    ...
    protected interface TimestampSeeker {
         ...
         * window is implementation specific, but should be small enough such that it's reasonable
         * for multiple such reads to occur during a seek operation.
         *
         * @param input             The {@link ExtractorInput} from which data should be peeked.
         * @param targetTimestamp   The target timestamp.
         * @param outputFrameHolder If {@link TimestampSearchResult#TYPE_TARGET_TIMESTAMP_FOUND} is
         *                          returned, this holder may be updated to hold the extracted frame
         *                          that contains the target frame/sample associated with the target
         *                          timestamp.
    ...
    /**
     * When seeking within the source, if the offset is smaller than or equal to this value, the
     * seek operation will be performed using a skip operation. Otherwise, the source will be
     * reloaded at the new seek position.
     */
     ...
     * @param timestampSeeker        A {@link TimestampSeeker} that will be used to search for
     *                               timestamps within the stream.
     ...
     * @param ceilingBytePosition    The position after the frame with maximum timestamp value in
     *                               the stream.
     * @param approxBytesPerFrame    Approximated bytes per frame.
     * @param minimumSearchRange     The minimum byte range that this binary seeker will operate on.
     *                               If the remaining search range is smaller than this value, the
     *                               search will stop, and the seeker will return the position at
     *                               the floor of the range as the result.
     */
    ...
    /**
     * Continues to handle the pending seek operation. Returns one of the {@code RESULT_} values
     * from {@link Extractor}.
     *
     * @param input              The {@link ExtractorInput} from which data should be read.
     * @param seekPositionHolder If {@link Extractor#RESULT_SEEK} is returned, this holder is
     *                           updated to hold the position of the required seek.
     * @param outputFrameHolder  If {@link Extractor#RESULT_CONTINUE} is returned, this holder may
     *                           be updated to hold the extracted frame that contains the target
     *                           sample. The caller needs to check the byte buffer limit to see if
     *                           an extracted frame is available.
    ...
    protected static class SeekOperationParams {
        ...
        /**
         * Returns the next position in the stream to search for target frame, given
         * [floorBytePosition, ceilingBytePosition), with corresponding [floorTimePosition,
         * ceilingTimePosition).
         */
        ...
        /**
         * Returns the floor byte position of the range [floorPosition, ceilingPosition) for this
         * seek operation.
         */
        ...
        /**
         * Returns the ceiling byte position of the range [floorPosition, ceilingPosition) for this
         * seek operation.
         */
    ...
    public static final class TimestampSearchResult {
        ...
        /**
         * Returns a result to signal that the current position in the input stream overestimates
         * the true position of the target frame, and the {@link BinarySearchSeeker} should modify
         * its {@link SeekOperationParams}'s ceiling timestamp and byte position using the given
         * values.
         */
        ...
        /**
         * Returns a result to signal that the current position in the input stream underestimates
         * the true position of the target frame, and the {@link BinarySearchSeeker} should modify
         * its {@link SeekOperationParams}'s floor timestamp and byte position using the given
         * values.
         */
