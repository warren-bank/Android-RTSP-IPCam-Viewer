...
public interface Extractor {
    ...
    /**
     * Returned by {@link #read(ExtractorInput, PositionHolder)} if the {@link ExtractorInput}
     * passed to the next {@link #read(ExtractorInput, PositionHolder)} is required to provide data
     ...
     * Returned by {@link #read(ExtractorInput, PositionHolder)} if the {@link ExtractorInput}
     * passed to the next {@link #read(ExtractorInput, PositionHolder)} is required to provide data
     * starting from a specified position in the stream.
     */
    int RESULT_SEEK = 1;
    /**
    ...
    /**
     * Returns whether this extractor can extract samples from the {@link ExtractorInput}, which
     * must provide data from the start of the stream.
     * <p>
     ...
     * {@link #RESULT_SEEK} is returned. If the extractor reached the end of the data provided by
     * the {@link ExtractorInput}, then {@link #RESULT_END_OF_INPUT} is returned.
     *
     ...
     * {@link #read(ExtractorInput, PositionHolder)} is required to provide data starting from
     * {@code position} in the stream. Valid random access positions are the start of the stream and
     * positions that can be obtained from any {@link SeekMap} passed to the {@link
     * ExtractorOutput}.
     *
