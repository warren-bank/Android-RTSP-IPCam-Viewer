...
public interface SeekMap {
    ...
    class Unseekable implements SeekMap {
        ...
        /**
         * @param durationUs    The duration of the stream in microseconds, or {@link C#TIME_UNSET}
     ...
     *
     * @return The duration of the stream in microseconds, or {@link C#TIME_UNSET} if the duration
     * is unknown.
     */
    long getDurationUs();
