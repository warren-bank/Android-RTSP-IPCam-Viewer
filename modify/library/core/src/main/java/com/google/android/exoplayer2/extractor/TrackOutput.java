...
public interface TrackOutput {
    ...
    final class CryptoData {
        ...
        /**
         * The number of encrypted blocks in the encryption pattern, 0 if pattern encryption does
         * not apply.
         */
     ...
     *                        allowed, and should result in {@link C#RESULT_END_OF_INPUT} being
     *                        returned. False if it should be considered an error, causing an {@link
     ...
     * @param offset         The number of bytes that have been passed to {@link
     *                       #sampleData(ExtractorInput, int, boolean)} or {@link
     *                       #sampleData(ParsableByteArray, int)} since the last byte belonging to
