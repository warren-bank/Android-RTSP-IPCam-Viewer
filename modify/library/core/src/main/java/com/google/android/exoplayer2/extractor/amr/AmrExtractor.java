...
public final class AmrExtractor implements Extractor {
    ...
    /**
     * The required number of samples in the stream with same sample size to classify the stream as
     * a constant-bitrate-stream.
     */
    ...
    /**
     * Returns the stream bitrate, given a frame size and the duration of that frame in
     * microseconds.
     *
