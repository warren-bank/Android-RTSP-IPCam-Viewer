...
public class MatroskaExtractor implements Extractor {
    ...
    /**
     * The value by which to divide a time in microseconds to convert it to the unit of the last
     * value in a subrip timecode (milliseconds).
     */
    ...
    /**
     * The value by which to divide a time in microseconds to convert it to the unit of the last
     * value in an SSA timecode (1/100ths of a second).
     */
     ...
     *
     * <p>See documentation on {@link #SSA_DIALOGUE_FORMAT} and {@link #SUBRIP_PREFIX} for why we
     * use
     * the duration as the end timecode.
     *
     * @param codecId      The subtitle codec; must be {@link #CODEC_ID_SUBRIP} or {@link
     *                     #CODEC_ID_ASS}.
    ...
    /**
     * Formats {@code timeUs} using {@code timecodeFormat}, and sets it as the end timecode in
    ...
    /**
     * Writes {@code length} bytes of sample data into {@code target} at {@code offset}, consisting
     * of pending {@link #sampleStrippedBytes} and any remaining data read from {@code input}.
     */
     ...
     * permits use of master seek entry. After building Cues sets the holder's position back to
     * where it was before.
     *
    ...
    /**
     * Returns an array that can store (at least) {@code length} elements, which will be either a
     * new array or {@code array} if it's not null and large enough.
     */
    ...
    /**
     * Rechunks TrueHD sample data into groups of {@link Ac3Util#TRUEHD_RECHUNK_SAMPLE_COUNT}
     * samples.
     */
    ...
    private static final class Track {
        ...
        @C.Projection
        public int projectionType = Format.NO_VALUE;
         ...
         *
         * @return The codec mime type and initialization data. If the compression type is not
         * supported then the mime type is set to {@link MimeTypes#VIDEO_UNKNOWN} and the
         * initialization data is {@code null}.
