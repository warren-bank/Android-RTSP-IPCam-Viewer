...
public final class Mp3Extractor implements Extractor {
    ...
    /**
     * The maximum number of bytes to peek when sniffing, excluding the ID3 header, before giving
     * up.
     */
     ...
     * @return A {@link Seeker} if seeking metadata was present and valid, or {@code null}
     * otherwise.
     * @throws IOException          Thrown if there was an error reading from the stream. Not
     *                              expected if the next two frames were already peeked during
     *                              synchronization.
     * @throws InterruptedException Thrown if reading from the stream was interrupted. Not expected
     *                              if the next two frames were already peeked during
     *                              synchronization.
     */
     ...
     * the provided {@code frame} may have seeking metadata, or {@link #SEEK_HEADER_UNSET}
     * otherwise. If seeking metadata is present, {@code frame}'s position is advanced past the
     * header.
     */
