...
/* package */ final class XingSeeker implements Seeker {
     ...
     *
     * @param inputLength     The length of the stream in bytes, or {@link C#LENGTH_UNSET} if
     *                        unknown.
     * @param position        The position of the start of this frame in the stream.
     * @param mpegAudioHeader The MPEG audio header associated with the frame.
     * @param frame           The data in this audio frame, with its position set to immediately
     *                        after the 'Xing' or 'Info' tag.
    ...
    /**
     * Entries are in the range [0, 255], but are stored as long integers for convenience. Null if
     * the table of contents was missing from the header, in which case seeking is not be
     * supported.
     */
    @Nullable
