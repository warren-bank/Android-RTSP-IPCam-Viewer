...
/* package */ final class AtomParsers {
     ...
     * @return A pair consisting of the media timescale defined as the number of time units that
     * pass in one second, and the language code.
     */
    ...
    private static void parseAudioSampleEntry(ParsableByteArray parent, int atomType, int position,
        ...
        while (childPosition - position < size) {
            ...
            if (childAtomType == Atom.TYPE_esds || (isQuickTime && childAtomType == Atom.TYPE_wave)) {
                ...
                Pair<Integer, Integer> audioSpecificConfig = CodecSpecificDataUtil.parseAlacAudioSpecificConfig(initializationData);
                sampleRate = audioSpecificConfig.first;
                channelCount = audioSpecificConfig.second;
            }
            childPosition += childAtomSize;
