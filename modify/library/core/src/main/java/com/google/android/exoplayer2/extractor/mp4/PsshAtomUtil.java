...
public final class PsshAtomUtil {
     ...
     *
     * <p>The scheme specific data is only parsed if the data is a valid PSSH atom matching the
     * given
     * UUID, or if the data is a valid PSSH atom of any type in the case that the passed UUID is
     * null.
     *
     * @param atom The atom to parse.
     * @param uuid The required UUID of the PSSH atom, or null to accept any UUID.
     * @return The parsed scheme specific data. Null if the input is not a valid PSSH atom, or if
     * the PSSH atom has an unsupported version, or if the PSSH atom does not match the passed
     * UUID.
     */
    public static @Nullable
