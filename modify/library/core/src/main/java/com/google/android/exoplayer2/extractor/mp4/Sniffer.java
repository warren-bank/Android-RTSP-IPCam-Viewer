...
/* package */ final class Sniffer {
     ...
     *
     * @param input The extractor input from which to peek data. The peek position will be
     *              modified.
    ...
    /**
     * Returns whether {@code brand} is an ftyp atom brand that is compatible with the MP4
     * extractors.
     */
