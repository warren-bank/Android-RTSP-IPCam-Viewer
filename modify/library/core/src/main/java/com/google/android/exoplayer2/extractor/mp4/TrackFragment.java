...
/* package */ final class TrackFragment {
    ...
    /**
     * If {@link #definesEncryptionData} is true, indicates the length of the sample encryption
     ...
     * Resets the fragment.
     * <p>
     * {@link #sampleCount} and {@link #nextFragmentDecodeTime} are set to 0, and both {@link
     * #definesEncryptionData} and {@link #sampleEncryptionDataNeedsFill} is set to false, and
     * {@link #trackEncryptionBox} is set to null.
     */
    public void reset() {
        trunCount = 0;
