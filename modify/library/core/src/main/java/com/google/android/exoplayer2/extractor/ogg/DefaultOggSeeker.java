...
/* package */ final class DefaultOggSeeker implements OggSeeker {
    ...
    /**
     * Performs a single step of a seeking binary search, returning the byte position from which
     * data should be provided for the next step, or {@link C#POSITION_UNSET} if the search has
     * converged. If the search has converged then {@link #skipToPageOfTargetGranule(ExtractorInput)}
     * should be called to skip to the target page.
     *
