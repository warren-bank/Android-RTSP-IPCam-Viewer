...
/* package */  final class OggPageHeader {
     ...
     * of the file up to the <em>end</em> of the page. Samples partially in the page that continue
     * on the next page do not count.
     */
     ...
     *              cannot be populated.
     * @return Whether the read was successful. The read fails if the end of the input is
