...
/* package */ interface OggSeeker {
     ...
     * or the final position for direct seeking. Returns null if {@link #read} has yet to return
     * -1.
     */
     ...
     * @return A non-negative position to seek the {@link ExtractorInput} to, or -(currentGranule +
     * 2) if the progressive seek has completed, or -1 otherwise.
