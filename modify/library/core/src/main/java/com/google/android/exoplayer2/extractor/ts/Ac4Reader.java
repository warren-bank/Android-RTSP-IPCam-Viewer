...
public final class Ac4Reader implements ElementaryStreamReader {
    ...
    /**
     * Locates the next syncword, advancing the position to the byte that immediately follows it. If
     * a syncword was not located, the position is advanced to the limit.
     *
