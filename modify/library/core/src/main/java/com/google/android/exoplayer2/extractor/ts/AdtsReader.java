...
public final class AdtsReader implements ElementaryStreamReader {
    ...
    /**
     * Returns the duration in microseconds per sample, or {@link C#TIME_UNSET} if the sample
     ...
     *
     * <p>SYNC word pattern can occur within AAC data, so we perform a few checks to make sure this
     * is
