...
public final class DefaultTsPayloadReaderFactory implements TsPayloadReader.Factory {
    ...
    /**
     * Prevents the creation of {@link AdtsReader} and {@link LatmReader} instances. This flag
     * should be enabled if the transport stream contains no packets for an AAC elementary stream
     * that is declared in the PMT.
     */
     ...
     * DefaultTsPayloadReaderFactory#DefaultTsPayloadReaderFactory(int, List)} should be used in
     * spite of any closed captions service descriptors. If this flag is disabled, {@code
     * closedCaptionFormats} will be ignored if the PMT contains closed captions service
     * descriptors.
     */
    ...
    /**
     * @param flags                A combination of {@code FLAG_*} values that control the behavior
     *                             of the created readers.
     * @param closedCaptionFormats {@link Format}s to be exposed by payload readers for streams with
     *                             embedded closed captions when no caption service descriptors are
     *                             provided. If {@link #FLAG_OVERRIDE_CAPTION_DESCRIPTORS} is set,
     *                             {@code closedCaptionFormats} overrides any descriptor
     *                             information. If not set, and {@code closedCaptionFormats} is
     *                             empty, a closed caption track with {@link Format#accessibilityChannel}
     *                             {@link Format#NO_VALUE} will be exposed.
     */
     ...
     * SeiReader} for the declared formats, or {@link #closedCaptionFormats} if the descriptor is
     * not present.
     *
     ...
     * {@link #closedCaptionFormats}. If unset, parses the PMT descriptor information and returns a
     * {@link List<Format>} for the declared formats, or {@link #closedCaptionFormats} if the
     * descriptor is not present.
     *
     * @param esInfo The {@link EsInfo} passed to {@link #createPayloadReader(int, EsInfo)}.
