...
public final class H262Reader implements ElementaryStreamReader {
     ...
     * @return A pair consisting of the {@link Format} and the frame duration in microseconds, or 0
    ...
    private static final class CsdBuffer {
         ...
         * @return Whether the csd data is now complete. If true is returned, neither this method
         * nor {@link #onData(byte[], int, int)} should be called again without an interleaving call
         * to {@link #reset()}.
         */
