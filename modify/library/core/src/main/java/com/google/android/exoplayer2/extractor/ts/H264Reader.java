...
public final class H264Reader implements ElementaryStreamReader {
     ...
     * @param detectAccessUnits    Whether to split the input stream into access units (samples)
     *                             based on slice headers. Pass {@code false} if the stream contains
     *                             access unit delimiters (AUDs).
     */
