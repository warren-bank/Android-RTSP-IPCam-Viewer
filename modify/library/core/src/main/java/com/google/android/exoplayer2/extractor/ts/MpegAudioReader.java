...
public final class MpegAudioReader implements ElementaryStreamReader {
     ...
     * first two bytes of the header are written into {@link #headerScratch}, and the position of
     * the source is advanced to the byte that immediately follows these two bytes.
     * <p>
     * If a frame header is not located then the position of the source is advanced to the limit,
     ...
     * output as sample data, and the position of the source is advanced to the byte that
     * immediately follows the header.
     * <p>
     * If a frame header is read in full but cannot be parsed then the state is changed to {@link
     * #STATE_READING_HEADER}.
     * <p>
     * If a frame header is not read in full then the position of the source is advanced to the
     ...
     * position of the source will have been advanced to the byte that immediately follows the end
     * of the frame.
     * <p>
