...
/* package */ final class TsDurationReader {
     ...
     *
     * <p>This reader reads the duration by reading PCR values of the PCR PID packets at the start
     * and
     * at the end of the stream, calculating the difference, and converting that into stream
     * duration.
     *
     ...
     * @param pcrPid             The PID of the packet stream within this TS stream that contains
     *                           PCR values.
