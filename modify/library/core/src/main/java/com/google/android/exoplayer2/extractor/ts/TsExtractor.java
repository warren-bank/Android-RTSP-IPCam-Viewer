...
public final class TsExtractor implements Extractor {
     ...
     *                                    {@code FLAG_*} values that control the behavior of the
     *                                    payload readers.
     */
    ...
    /**
     * @param mode                        Mode for the extractor. One of {@link #MODE_MULTI_PMT},
     *                                    {@link #MODE_SINGLE_PMT} and {@link #MODE_HLS}.
     * @param defaultTsPayloadReaderFlags A combination of {@link DefaultTsPayloadReaderFactory}
     *                                    {@code FLAG_*} values that control the behavior of the
     *                                    payload readers.
     */
    ...
    /**
     * @param mode                 Mode for the extractor. One of {@link #MODE_MULTI_PMT}, {@link
     *                             #MODE_SINGLE_PMT} and {@link #MODE_HLS}.
     * @param timestampAdjuster    A timestamp adjuster for offsetting and scaling sample
     *                             timestamps.
    ...
    private class PmtReader implements SectionPayloadReader {
        ...
        /**
         * Returns the stream info read from the available descriptors. Sets {@code data}'s position
         * to the end of the descriptors.
         *
         * @param data   A buffer with its position set to the start of the first descriptor.
         * @param length The length of descriptors to read from the current position in {@code
         *               data}.
