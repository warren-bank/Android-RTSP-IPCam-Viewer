...
public interface TsPayloadReader {
    ...
    interface Factory {
        ...
        /**
         * Returns a {@link TsPayloadReader} for a given stream type and elementary stream
         * information. May return null if the stream type is not supported.
         *
         * @param streamType Stream type value as defined in the PMT entry or associated
         *                   descriptors.
    ...
    final class EsInfo {
        ...
        /**
         * @param streamType       The type of the stream as defined by the {@link
         *                         TsExtractor}{@code .TS_STREAM_TYPE_*}.
         * @param language         The language of the stream, as defined by ISO/IEC 13818-1,
         *                         section 2.6.18.
    ...
    /**
     * Holds information about a DVB subtitle, as defined in ETSI EN 300 468 V1.11.1 section
     * 6.2.41.
     */
    ...
    final class TrackIdGenerator {
        ...
        /**
         * Returns the last generated track id. Must be called after the first {@link
         * #generateNewId()} call.
         *
        ...
        /**
         * Returns the last generated format id, with the format {@code "programNumber/trackId"}. If
         * no {@code programNumber} was provided, the {@code trackId} alone is used as format id.
         * Must be called after the first {@link #generateNewId()} call.
         *
         * @return The last generated format id, with the format {@code "programNumber/trackId"}. If
         * no {@code programNumber} was provided, the {@code trackId} alone is used as format id.
         */
    ...
    /**
     * Contextual flags indicating the presence of indicators in the TS packet or PES packet
     * headers.
     */
    @Documented
    ...
    /**
     * Indicates the presence of the random_access_indicator in the TS packet header adaptation
     * field.
     */
     ...
     * @param idGenerator       A {@link PesReader.TrackIdGenerator} that generates unique track ids
     *                          for the {@link TrackOutput}s.
     */
