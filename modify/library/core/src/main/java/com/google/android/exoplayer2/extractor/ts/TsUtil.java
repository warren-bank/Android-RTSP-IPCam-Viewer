...
public final class TsUtil {
    /**
     * Returns the position of the first TS_SYNC_BYTE within the range [startPosition,
     * limitPosition) from the provided data array, or returns limitPosition if sync byte could not
     * be found.
     */
