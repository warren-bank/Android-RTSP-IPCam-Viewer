...
public final class MetadataRenderer extends BaseRenderer implements Callback {
     ...
     * metadata. If it does, then we recursively decode the wrapped metadata. If it doesn't
     * (recursion base-case), we add the {@link Metadata.Entry} to {@code decodedEntries} (output
     * parameter).
     */
