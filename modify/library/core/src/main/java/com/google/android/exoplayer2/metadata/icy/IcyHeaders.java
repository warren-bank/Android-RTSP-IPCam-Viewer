...
public final class IcyHeaders implements Metadata.Entry {
    ...
    /**
     * Bitrate in bits per second ({@code (icy-br * 1000)}), or {@link Format#NO_VALUE} if the
    ...
    /**
     * The interval in bytes between metadata chunks ({@code icy-metaint}), or {@link
     * C#LENGTH_UNSET} if the header was not present.
     */
