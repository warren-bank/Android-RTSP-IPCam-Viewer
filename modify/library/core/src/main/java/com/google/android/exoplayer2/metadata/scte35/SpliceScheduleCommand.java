...
public final class SpliceScheduleCommand extends SpliceCommand {
    ...
    public static final class Event {
        ...
        /**
         * Represents the time of the signaled splice event as the number of seconds since 00 hours
         * UTC, January 6th, 1980, with the count of intervening leap seconds included.
         */
