...
/* package */ final class ActionFile {
    ...
    /**
     * @param actionFile The file from which {@link DownloadRequest DownloadRequests} will be
     *                   loaded.
     */
     ...
     *
     * @return The loaded {@link DownloadRequest DownloadRequests}, or an empty array if the file
     * does not exist.
