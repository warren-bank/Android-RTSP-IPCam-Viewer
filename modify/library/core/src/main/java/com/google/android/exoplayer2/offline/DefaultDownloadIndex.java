...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
     ...
     * name=""}.
     *
     * <p>Applications that only have one download index may use this constructor. Applications
     * that
     ...
     *
     * @param databaseProvider Provides the SQLite database in which downloads are persisted.
     * @param name             The name of the index. This name is incorporated into the names of
     *                         the SQLite tables in which downloads are persisted.
     */
