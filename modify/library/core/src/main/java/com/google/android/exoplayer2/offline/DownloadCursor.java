...
public interface DownloadCursor extends Closeable {
     ...
     * the download set is first returned the cursor will be at positon -1, which is before the
     * first download. After the last download is returned another call to next() will leave the
     * cursor past the last entry, at a position of count().
     *
