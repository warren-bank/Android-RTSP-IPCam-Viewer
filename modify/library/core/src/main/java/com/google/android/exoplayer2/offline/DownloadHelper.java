...
public final class DownloadHelper {
     ...
     * @param renderersFactory  A {@link RenderersFactory} creating the renderers for which tracks
     *                          are selected.
     ...
     * @param uri                     A manifest {@link Uri}.
     * @param dataSourceFactory       A {@link DataSource.Factory} used to load the manifest.
     * @param renderersFactory        A {@link RenderersFactory} creating the renderers for which
     *                                tracks are selected.
     * @param drmSessionManager       An optional {@link DrmSessionManager} used by the renderers
     *                                created by {@code renderersFactory}.
     * @param trackSelectorParameters {@link DefaultTrackSelector.Parameters} for selecting tracks
     *                                for downloading.
     * @return A {@link DownloadHelper} for DASH streams.
     * @throws IllegalStateException If the DASH module is missing.
     */
     ...
     *
     * @param downloadType            A download type. This value will be used as {@link
     *                                DownloadRequest#type}.
     * @param uri                     A {@link Uri}.
     * @param cacheKey                An optional cache key.
     * @param mediaSource             A {@link MediaSource} for which tracks are selected, or null
     *                                if no track selection needs to be made.
     * @param trackSelectorParameters {@link DefaultTrackSelector.Parameters} for selecting tracks
     *                                for downloading.
     ...
     * @return The track groups for the period. May be {@link TrackGroupArray#EMPTY} for single
     * stream content.
     */
    ...
    /**
     * Returns the mapped track info for the given period. Must not be called until after
     * preparation completes.
     *
     * @param periodIndex The period index.
     ...
     *                                       be selected for downloading if no track with one of the
     *                                       specified {@code languages} is available.
     * @param languages                      A list of text languages for which tracks should be
     *                                       added to the download selection, as IETF BCP 47
     *                                       conformant tags.
     */
     ...
     * @param trackSelectorParameters The {@link DefaultTrackSelector.Parameters} to obtain the new
     *                                selection of tracks.
     * @param overrides               A list of {@link SelectionOverride SelectionOverrides} to
     *                                apply to the {@code trackSelectorParameters}. If empty, {@code
     *                                trackSelectorParameters} are used as they are.
     */
    ...
    /**
     * Builds a {@link DownloadRequest} for downloading the selected tracks. Must not be called
     * until after preparation completes. The uri of the {@link DownloadRequest} will be used as
     * content id.
     *
    ...
    /**
     * Builds a {@link DownloadRequest} for downloading the selected tracks. Must not be called
     * until after preparation completes.
     *
