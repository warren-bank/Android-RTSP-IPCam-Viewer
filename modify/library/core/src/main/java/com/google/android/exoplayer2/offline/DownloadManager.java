 ...
 *
 * <p>A download manager instance must be accessed only from the thread that created it, unless
 * that
...
public final class DownloadManager {
     ...
     * @param cache            A cache to be used to store downloaded data. The cache should be
     *                         configured with an {@link CacheEvictor} that will not evict
     *                         downloaded content, for example {@link NoOpCacheEvictor}.
     * @param upstreamFactory  A {@link Factory} for creating {@link DataSource}s for downloading
     *                         data.
     */
     ...
     *
     * @param maxParallelDownloads The maximum number of parallel downloads. Must be greater than
     *                             0.
     */
    ...
    /**
     * Returns current downloads. Downloads that are in terminal states (i.e. completed or failed)
     * are not included. To query all downloads including those in terminal states, use {@link
     ...
     * #getMaxParallelDownloads() maxParallelDownloads} will be started, excluding those with
     * non-zero {@link Download#stopReason stopReasons}.
     */
     ...
     *
     * @param id         The content id of the download to update, or {@code null} to set the stop
