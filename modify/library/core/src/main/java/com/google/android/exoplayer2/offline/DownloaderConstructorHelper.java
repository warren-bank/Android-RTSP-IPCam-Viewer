...
public final class DownloaderConstructorHelper {
    ...
    /**
     * @param cache                      Cache instance to be used to store downloaded data.
     * @param upstreamFactory            A {@link DataSource.Factory} for creating {@link
     *                                   DataSource}s for downloading data.
     * @param cacheReadDataSourceFactory A {@link DataSource.Factory} for creating {@link
     *                                   DataSource}s for reading data from the cache. If null then
     *                                   a {@link FileDataSource.Factory} will be used.
     * @param cacheWriteDataSinkFactory  A {@link DataSink.Factory} for creating {@link DataSource}s
     *                                   for writing data to the cache. If null then a {@link
     *                                   CacheDataSinkFactory} will be used.
     * @param priorityTaskManager        A {@link PriorityTaskManager} to use when downloading. If
     *                                   non-null, downloaders will register as tasks with priority
     *                                   {@link C#PRIORITY_DOWNLOAD} whilst downloading.
     */
