...
public abstract class SegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
     ...
     * @param streamKeys        Keys defining which streams in the manifest should be selected for
     *                          download. If empty, all streams are downloaded.
     ...
     *                            segments from being listed. If true then a partial segment list
     *                            will be returned. If false an {@link IOException} will be thrown.
     * @return The list of downloadable {@link Segment}s.
     * @throws InterruptedException Thrown if the thread was interrupted.
     * @throws IOException          Thrown if {@code allowPartialIndex} is false and a load error
     *                              occurs, or if the media is not in a form that allows for its
     *                              segments to be listed.
     */
