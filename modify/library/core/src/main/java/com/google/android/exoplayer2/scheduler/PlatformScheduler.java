...
public final class PlatformScheduler implements Scheduler {
     ...
     * @param jobId   An identifier for the jobs scheduled by this instance. If the same identifier
     *                was used by a previous instance, anything scheduled by the previous instance
     *                will be canceled by this instance if {@link #schedule(Requirements, String,
     *                String)} or {@link #cancel()} are called.
     */
