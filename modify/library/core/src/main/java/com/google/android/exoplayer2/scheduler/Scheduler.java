...
public interface Scheduler {
     ...
     *
     * <p>The service to be started must be declared in the manifest of {@code servicePackage} with
     * an
     ...
     * make itself a foreground service, as documented by {@link Service#startForegroundService(Intent)}.
     *
