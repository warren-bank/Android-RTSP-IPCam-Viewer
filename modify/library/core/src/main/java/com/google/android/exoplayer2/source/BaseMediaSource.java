...
public abstract class BaseMediaSource implements MediaSource {
     ...
     *                              this listener should usually be only informed of transfers
     *                              related to the media loads and not of auxiliary loads for
     ...
     *
     * @param mediaPeriodId The {@link MediaPeriodId} to be reported with the events. May be null,
     *                      if the events do not belong to a specific media period.
     ...
     * @param mediaPeriodId     The {@link MediaPeriodId} to be reported with the events. May be
     *                          null, if the events do not belong to a specific media period.
     * @param mediaTimeOffsetMs The offset to be added to all media times, in milliseconds.
     * @return An event dispatcher with pre-configured media period id and time offset.
     */
    protected final MediaSourceEventListener.EventDispatcher createEventDispatcher(
