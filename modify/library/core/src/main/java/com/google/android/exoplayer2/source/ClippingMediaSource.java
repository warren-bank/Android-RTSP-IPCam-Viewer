...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    /**
     * Creates a new clipping source that wraps the specified source and provides samples between
     * the specified start and end position.
     *
     * @param mediaSource     The single-period source to wrap.
     * @param startPositionUs The start position within {@code mediaSource}'s window at which to
     ...
     *                        providing samples, in microseconds. Specify {@link
     *                        C#TIME_END_OF_SOURCE} to provide samples from the specified start
     *                        point up to the end of the source. Specifying a position that exceeds
     *                        the {@code mediaSource}'s duration will also result in the end of the
     *                        source not being clipped.
     */
     ...
     *
     * @param mediaSource The single-period source to wrap.
     * @param durationUs  The duration from the default position in the window in {@code
     *                    mediaSource}'s timeline at which to stop providing samples. Specifying a
     *                    duration that exceeds the {@code mediaSource}'s duration will result in
     *                    the end of the source not being clipped.
     */
     ...
     * enableInitialPositionDiscontinuity} to suppress an initial discontinuity when a period is
     * first read from.
     *
     * <p>For live streams, if the clipping positions should move with the live window, pass {@code
     * true} to {@code allowDynamicClippingUpdates}. Otherwise, the live stream ends when the
     * playback reaches {@code endPositionUs} in the last reported live window at the time a media
     * period was created.
     *
     * @param mediaSource                 The single-period source to wrap.
     * @param startPositionUs             The start position at which to start providing samples, in
     *                                    microseconds. If {@code relativeToDefaultPosition} is
     *                                    {@code false}, this position is relative to the start of
     *                                    the window in {@code mediaSource}'s timeline. If {@code
     *                                    relativeToDefaultPosition} is {@code true}, this position
     *                                    is relative to the default position in the window in
     *                                    {@code mediaSource}'s timeline.
     * @param endPositionUs               The end position at which to stop providing samples, in
     *                                    microseconds. Specify {@link C#TIME_END_OF_SOURCE} to
     *                                    provide samples from the specified start point up to the
     *                                    end of the source. Specifying a position that exceeds the
     *                                    {@code mediaSource}'s duration will also result in the end
     *                                    of the source not being clipped. If {@code
     *                                    relativeToDefaultPosition} is {@code false}, the specified
     *                                    position is relative to the start of the window in {@code
     *                                    mediaSource}'s timeline. If {@code relativeToDefaultPosition}
     *                                    is {@code true}, this position is relative to the default
     *                                    position in the window in {@code mediaSource}'s timeline.
     ...
     *                                    live window. If {@code false}, playback ends when it
     *                                    reaches {@code endPositionUs} in the last reported live
     *                                    window at the time a media period was created.
     * @param relativeToDefaultPosition   Whether {@code startPositionUs} and {@code endPositionUs}
     *                                    are relative to the default position in the window in
     *                                    {@code mediaSource}'s timeline.
     */
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
         ...
         * @param endUs    The end position in microseconds for the clipped timeline relative to the
         *                 start of {@code timeline}, or {@link C#TIME_END_OF_SOURCE} to clip no
