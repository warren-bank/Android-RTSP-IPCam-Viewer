...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
     ...
     *
     * <p>{@link #onChildSourceInfoRefreshed(Object, MediaSource, Timeline)} will be called when
     * the
     * child source updates its timeline with the same {@code id} passed to this method.
     *
     * <p>Any child sources that aren't explicitly released with {@link
     * #releaseChildSource(Object)}
     * will be released in {@link #releaseSourceInternal()}.
     *
     * @param id          A unique id to identify the child source preparation. Null is allowed as
     *                    an id.
     ...
     * {@link MediaSourceEventListener#onMediaPeriodReleased(int, MediaPeriodId)} events of the
     * given media period should be reported. The default implementation is to always report these
     * events.
     *
