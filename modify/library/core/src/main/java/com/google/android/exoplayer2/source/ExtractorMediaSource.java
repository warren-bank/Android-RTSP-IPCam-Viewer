...
public final class ExtractorMediaSource extends CompositeMediaSource<Void> {
    ...
    public interface EventListener {
         ...
         * <p>
         * This method being called does not indicate that playback has failed, or that it will
         * fail. The player may be able to recover from the error and continue. Hence applications
         * should
         * <em>not</em> implement this method to display a user visible error or initiate an
         * application
         * level retry ({@link Player.EventListener#onPlayerError} is the appropriate place to
         * implement such behavior). This method is called to provide the application with an
         * opportunity to log the error if it wishes to do so.
         *
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        /**
         * Sets the factory for {@link Extractor}s to process the media stream. The default value is
         * an instance of {@link DefaultExtractorsFactory}.
         *
         * @param extractorsFactory A factory for {@link Extractor}s to process the media stream. If
         *                          the possible formats are known, pass a factory that instantiates
         *                          extractors for those formats.
        ...
        /**
         * Sets the custom key that uniquely identifies the original stream. Used for cache
         * indexing. The default value is {@code null}.
         *
         ...
         * MediaPeriod.Callback#onContinueLoadingRequested(SequenceableLoader)}. The default value
         * is {@link #DEFAULT_LOADING_CHECK_INTERVAL_BYTES}.
         *
         * @param continueLoadingCheckIntervalBytes The number of bytes that should be loaded
         *                                          between each invocation of {@link
     ...
     *                          possible formats are known, pass a factory that instantiates
     *                          extractors for those formats. Otherwise, pass a {@link
     *                          DefaultExtractorsFactory} to use default extractors.
     * @param eventHandler      A handler for events. May be null if delivery of events is not
     *                          required.
    ...
    /**
     * @param uri                               The {@link Uri} of the media stream.
     * @param dataSourceFactory                 A factory for {@link DataSource}s to read the
     *                                          media.
     * @param extractorsFactory                 A factory for {@link Extractor}s to process the
     *                                          media stream. If the possible formats are known,
     *                                          pass a factory that instantiates extractors for
     *                                          those formats. Otherwise, pass a {@link
     *                                          DefaultExtractorsFactory} to use default
     *                                          extractors.
     * @param eventHandler                      A handler for events. May be null if delivery of
     *                                          events is not required.
     * @param eventListener                     A listener of events. May be null if delivery of
     *                                          events is not required.
     ...
     *                                          each invocation of {@link MediaPeriod.Callback#onContinueLoadingRequested(SequenceableLoader)}.
     * @deprecated Use {@link Factory} instead.
     */
    @Deprecated
    public ExtractorMediaSource(
