...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public interface PrepareErrorListener {
        ...
        /**
         * Called the first time an error occurs while refreshing source info or preparing the
         * period.
         */
     ...
     *
     * @param listener An listener to be notified of media period preparation errors. If a listener
     *                 is set, {@link #maybeThrowPrepareError()} will not throw but will instead
     *                 pass the first preparation error (if any) to the listener.
     */
    ...
    /**
     * Overrides the default prepare position at which to prepare the media period. This value is
     * only used if called before {@link #createPeriod(MediaPeriodId)}.
     *
     ...
     *
     * @param id The identifier that should be used to create the media period from the media
     *           source.
     */
