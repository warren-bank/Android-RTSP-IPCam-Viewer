...
public final class MaskingMediaSource extends CompositeMediaSource<Void> {
     ...
     *                           manifest loads and other initial preparation steps happen
     *                           immediately. If true, these initial preparations are triggered only
     *                           when the player starts buffering the media.
     */
    ...
    private static final class MaskingTimeline extends ForwardingTimeline {
         ...
         * @param firstWindowUid The window UID in the timeline which will be replaced by the
         *                       already assigned {@link Window#SINGLE_WINDOW_UID}.
         * @param firstPeriodUid The period UID in the timeline which will be replaced by the
         *                       already assigned {@link #DUMMY_EXTERNAL_PERIOD_UID}.
         */
