 ...
 * these timelines by calling {@link MediaSourceCaller#onSourceInfoRefreshed} on the {@link
 * MediaSourceCaller}s passed to {@link #prepareSource(MediaSourceCaller, TransferListener)}.
 * <li>To provide {@link MediaPeriod} instances for the periods in its timeline. MediaPeriods are
 * obtained by calling {@link #createPeriod(MediaPeriodId, Allocator, long)}, and provide a way for
...
public interface MediaSource {
    ...
    final class MediaPeriodId {
        ...
        /**
         * The sequence number of the window in the buffered sequence of windows this media period
         * is part of. {@link C#INDEX_UNSET} if the media period id is not part of a buffered
         * sequence of windows.
         */
        ...
        /**
         * Creates a media period identifier for a dummy period which is not part of a buffered
         * sequence of windows.
         *
         ...
         * @param windowSequenceNumber The sequence number of the window in the buffered sequence of
         *                             windows this media period is part of.
         * @param nextAdGroupIndex     The index of the next ad group to which the media period's
         *                             content is clipped.
         */
        ...
        /**
         * Creates a media period identifier that identifies an ad within an ad group at the
         * specified timeline period.
         *
         * @param periodUid            The unique id of the timeline period that contains the ad
         *                             group.
        ...
        /**
         * Returns a copy of this period identifier but with {@code newPeriodUid} as its period
         * uid.
         */
     ...
     *
     * <p>{@link MediaSourceCaller#onSourceInfoRefreshed(MediaSource, Timeline)} will be called
     * once
     * the source has a {@link Timeline}.
     *
     * <p>For each call to this method, a call to {@link #releaseSource(MediaSourceCaller)} is
     * needed
     ...
     *                              transfers. May be null if no listener is available. Note that
     *                              this listener should be only informed of transfers related to
     *                              the media loads and not of auxiliary loads for manifests and
     *                              other data.
     */
     ...
     * <p>Should not be called directly from application code.
     *
     * <p>Must only be called after all {@link MediaPeriod MediaPeriods} previously created by
     * {@link
