...
public interface MediaSourceEventListener {
    ...
    final class LoadEventInfo {
        ...
        /**
         * The {@link Uri} from which data is being read. The uri will be identical to the one in
         * {@link #dataSpec}.uri unless redirection has occurred. If redirection has occurred, this
         ...
         * @param uri               The {@link Uri} from which data is being read. The uri must be
         *                          identical to the one in {@code dataSpec.uri} unless redirection
         *                          has occurred. If redirection has occurred, this is the uri after
         *                          redirection.
         * @param responseHeaders   The response headers associated with the load, or an empty map
         *                          if unavailable.
         * @param elapsedRealtimeMs The value of {@link SystemClock#elapsedRealtime} at the time of
         *                          the load event.
         * @param loadDurationMs    The duration of the load up to the event time.
         * @param bytesLoaded       The number of bytes that were loaded up to the event time. For
         *                          compressed network responses, this is the decompressed size.
         */
    ...
    final class MediaLoadData {
        ...
        /**
         * Optional data associated with the selection of the track to which the data belongs. Null
         * if the data does not belong to a track.
         */
        @Nullable
        ...
        /**
         * The end time of the media, or {@link C#TIME_UNSET} if the data does not belong to a
         * specific media period or the end time is unknown.
         */
         ...
         *
         * @param dataType             One of the {@link C} {@code DATA_TYPE_*} constants defining
         *                             the type of data.
         * @param trackType            One of the {@link C} {@code TRACK_TYPE_*} constants if the
         *                             data corresponds to media of a specific type. {@link
         *                             C#TRACK_TYPE_UNKNOWN} otherwise.
         * @param trackFormat          The format of the track to which the data belongs. Null if
         *                             the data does not belong to a track.
         * @param trackSelectionReason One of the {@link C} {@code SELECTION_REASON_*} constants if
         *                             the data belongs to a track. {@link C#SELECTION_REASON_UNKNOWN}
         *                             otherwise.
         * @param trackSelectionData   Optional data associated with the selection of the track to
         *                             which the data belongs. Null if the data does not belong to a
         *                             track.
         * @param mediaStartTimeMs     The start time of the media, or {@link C#TIME_UNSET} if the
         *                             data does not belong to a specific media period.
         * @param mediaEndTimeMs       The end time of the media, or {@link C#TIME_UNSET} if the
         *                             data does not belong to a specific media period or the end
         *                             time is unknown.
         */
     ...
     *
     * @param windowIndex   The window index in the timeline of the media source this load belongs
     *                      to.
     * @param mediaPeriodId The {@link MediaPeriodId} this load belongs to. Null if the load does
     *                      not belong to a specific media period.
     * @param loadEventInfo The {@link LoadEventInfo} corresponding to the event. The value of
     *                      {@link LoadEventInfo#uri} won't reflect potential redirection yet and
     *                      {@link LoadEventInfo#responseHeaders} will be empty.
     ...
     * @param mediaPeriodId The {@link MediaPeriodId} this load belongs to. Null if the load does
     *                      not belong to a specific media period.
     * @param loadEventInfo The {@link LoadEventInfo} corresponding to the event. The values of
     *                      {@link LoadEventInfo#elapsedRealtimeMs} and {@link
     *                      LoadEventInfo#bytesLoaded} are relative to the corresponding {@link
     ...
     *
     * <p>This method being called does not indicate that playback has failed, or that it will
     * fail.
     * The player may be able to recover from the error and continue. Hence applications should
     * <em>not</em> implement this method to display a user visible error or initiate an
     * application
    ...
    final class EventDispatcher {
        ...
        /**
         * Creates a view of the event dispatcher with pre-configured window index, media period id,
         * and media time offset.
         *
        ...
        /**
         * Dispatches {@link #onLoadError(int, MediaPeriodId, LoadEventInfo, MediaLoadData,
         * IOException, boolean)}.
         */
