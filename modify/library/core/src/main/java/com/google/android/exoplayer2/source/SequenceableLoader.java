...
public interface SequenceableLoader {
    ...
    interface Callback<T extends SequenceableLoader> {
        ...
        /**
         * Called by the loader to indicate that it wishes for its {@link #continueLoading(long)}
     ...
     *                   which this loader belongs has not yet started, the value will be the
     *                   starting position in the period minus the duration of any media in previous
     *                   periods still to be played.
