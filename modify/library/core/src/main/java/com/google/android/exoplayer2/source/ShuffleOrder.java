...
public interface ShuffleOrder {
    ...
    class DefaultShuffleOrder implements ShuffleOrder {
        ...
        /**
         * Creates an instance with a specified length and the specified random seed. Shuffle orders
         * of the same length initialized with the same random seed are guaranteed to be equal.
         *
         * @param length     The length of the shuffle order.
        ...
        /**
         * Creates an instance with a specified shuffle order and the specified random seed. The
         * random seed is used for {@link #cloneAndInsert(int, int)} invocations.
         *
     ...
     *
     * @param index An index.
     * @return The index before {@code index}, or {@link C#INDEX_UNSET} if {@code index} is the
     * first element.
     */
    ...
    /**
     * Returns the first index in the shuffle order, or {@link C#INDEX_UNSET} if the shuffle order
     * is empty.
     */
    int getFirstIndex();
     ...
     * @param indexToExclusive The smallest index (must be greater or equal to {@code indexFrom})
