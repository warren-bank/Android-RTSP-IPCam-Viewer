...
public final class SinglePeriodTimeline extends Timeline {
     ...
     *                                     microseconds.
     * @param windowDefaultStartPositionUs The default position relative to the start of the window
     *                                     at which to begin playback, in microseconds.
     * @param isSeekable                   Whether seeking is supported within the window.
     * @param isDynamic                    Whether the window may change when the timeline is
     *                                     updated.
     * @param isLive                       Whether the window is live.
     * @param manifest                     The manifest. May be (@code null}.
