...
public final class SingleSampleMediaSource extends BaseMediaSource {
    ...
    public static final class Factory {
         ...
         *
         * @param dataSourceFactory The factory from which the {@link DataSource} to read the media
         *                          will be obtained.
         */
         ...
         *                                     load errors will be propagated normally by {@link
    ...
    /**
     * @param uri                          The {@link Uri} of the media stream.
     * @param dataSourceFactory            The factory from which the {@link DataSource} to read the
     *                                     media will be obtained.
     * @param format                       The {@link Format} associated with the output track.
     * @param durationUs                   The duration of the media stream in microseconds.
     * @param minLoadableRetryCount        The minimum number of times to retry if a loading error
     *                                     occurs.
     * @param eventHandler                 A handler for events. May be null if delivery of events
     *                                     is not required.
     * @param eventListener                A listener of events. May be null if delivery of events
     *                                     is not required.
     * @param eventSourceId                An identifier that gets passed to {@code eventListener}
     *                                     methods.
     * @param treatLoadErrorsAsEndOfStream If true, load errors will not be propagated by sample
     *                                     streams, treating them as ended instead. If false, load
     *                                     errors will be propagated normally by {@link
     *                                     SampleStream#maybeThrowError()}.
     * @deprecated Use {@link Factory} instead.
     */
    @Deprecated
    ...
    /**
     * Wraps a deprecated {@link EventListener}, invoking its callback from the equivalent callback
     * in {@link MediaSourceEventListener}.
     */
    @Deprecated
    @SuppressWarnings("deprecation")
