...
public final class AdPlaybackState {
     ...
     *
     * <p>Instances are immutable. Call the {@code with*} methods to get new instances that have
     * the
     * required changes.
     */
    public static final class AdGroup {
        ...
        /**
         * Returns the index of the first ad in the ad group that should be played, or {@link
         * #count} if no ads should be played.
         */
         ...
         * {@code lastPlayedAdIndex}, or {@link #count} if no later ads should be played.
         */
        ...
        /**
         * Returns a new instance with the ad count set to {@code count}. This method may only be
         * called if this instance's ad count has not yet been specified.
         */
        @CheckResult
        ...
        /**
         * Returns a new instance with the specified {@code uri} set for the specified ad, and the
         * ad marked as {@link #AD_STATE_AVAILABLE}. The specified ad must currently be in {@link
         * #AD_STATE_UNAVAILABLE}, which is the default state.
         *
         * <p>This instance's ad count may be unknown, in which case {@code index} must be less than
         * the
         * ad count specified later. Otherwise, {@code index} must be less than the current ad
         * count.
         */
        @CheckResult
        ...
        /**
         * Returns an instance with all unavailable and available ads marked as skipped. If the ad
         * count hasn't been set, it will be set to zero.
         */
        @CheckResult
     ...
     *                   {@link C#TIME_END_OF_SOURCE} for the end of the stream (in which case the
     *                   index of any unplayed postroll ad group will be returned).
     ...
     *
     * @param positionUs       The position after which to find an ad group, in microseconds, or
     *                         {@link C#TIME_END_OF_SOURCE} for the end of the stream (in which case
     *                         there can be no ad group after the position).
    ...
    /**
     * Returns an instance with the number of ads in {@code adGroupIndex} resolved to {@code
     * adCount}. The ad count must be greater than zero.
     */
    @CheckResult
