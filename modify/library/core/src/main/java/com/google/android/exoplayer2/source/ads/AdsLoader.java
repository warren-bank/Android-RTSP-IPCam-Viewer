...
public interface AdsLoader {
    ...
    interface AdViewProvider {
         ...
         *
         * <p>Each view must be either a fully transparent overlay (for capturing touch events), or
         * a
         * small piece of transient UI that is essential to the user experience of playback (such as
         * a button to pause/resume playback or a transient full-screen or cast button). For more
     ...
     *
     * <p>This method must be called before the player is prepared with media using this ads
     * loader.
     *
    ...
    /**
     * Releases the loader. Must be called by the application on the main thread when the instance
     * is no longer needed.
     */
    void release();
     ...
     *                     {@link C#TYPE_DASH}, {@link C#TYPE_HLS}, {@link C#TYPE_SS} and {@link
     *                     C#TYPE_OTHER}.
     */
    void setSupportedContentTypes(@C.ContentType int... contentTypes);

    /**
     * Starts using the ads loader for playback. Called on the main thread by {@link
     * AdsMediaSource}.
     *
    ...
    /**
     * Stops using the ads loader for playback and deregisters the event listener. Called on the
     * main thread by {@link AdsMediaSource}.
     */
    void stop();
