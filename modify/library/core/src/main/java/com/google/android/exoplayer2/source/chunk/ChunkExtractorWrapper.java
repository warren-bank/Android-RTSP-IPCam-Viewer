...
public final class ChunkExtractorWrapper implements ExtractorOutput {
     ...
     *                                   com.google.android.exoplayer2.C} {@code TRACK_TYPE_*}
     *                                   constants.
     * @param primaryTrackManifestFormat A manifest defined {@link Format} whose data should be
     *                                   merged into any sample {@link Format} output from the
     *                                   {@link Extractor} for the primary track.
     */
     ...
     *
     * @param trackOutputProvider The provider of {@link TrackOutput}s that will receive sample
     *                            data.
     * @param startTimeUs         The start position in the new chunk, or {@link C#TIME_UNSET} to
     *                            output samples from the start of the chunk.
     * @param endTimeUs           The end position in the new chunk, or {@link C#TIME_UNSET} to
     *                            output samples to the end of the chunk.
     */
    public void init(
