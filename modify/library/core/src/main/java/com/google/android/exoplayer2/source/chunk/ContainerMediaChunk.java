...
public class ContainerMediaChunk extends BaseMediaChunk {
     ...
     * @param startTimeUs          The start time of the media contained by the chunk, in
     *                             microseconds.
     * @param endTimeUs            The end time of the media contained by the chunk, in
     *                             microseconds.
     ...
     * @param chunkIndex           The index of the chunk, or {@link C#INDEX_UNSET} if it is not
     *                             known.
     * @param chunkCount           The number of chunks in the underlying media that are spanned by
     *                             this instance. Normally equal to one, but may be larger if
     *                             multiple chunks as defined by the underlying media are being
     *                             merged into a single load.
     * @param sampleOffsetUs       An offset to add to the sample timestamps parsed by the
     *                             extractor.
