...
public class Cue {
    ...
    /**
     * The type of anchor, which may be unset. One of {@link #TYPE_UNSET}, {@link
     * #ANCHOR_TYPE_START}, {@link #ANCHOR_TYPE_MIDDLE} or {@link #ANCHOR_TYPE_END}.
     */
    @Documented
    ...
    /**
     * Anchors the right (for horizontal positions) or bottom (for vertical positions) edge of the
     * cue box.
     */
     ...
     * {@link #TEXT_SIZE_TYPE_FRACTIONAL}, {@link #TEXT_SIZE_TYPE_FRACTIONAL_IGNORE_PADDING} or
     * {@link #TEXT_SIZE_TYPE_ABSOLUTE}.
     */
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({
     ...
     *
     * <p>{@link #LINE_TYPE_FRACTION} indicates that {@link #line} is a fractional position within
     * the
     * viewport.
     *
     * <p>{@link #LINE_TYPE_NUMBER} indicates that {@link #line} is a line number, where the size
     * of
     ...
     * && lineAnchor == ANCHOR_TYPE_END)} positions a (potentially multi-line) cue at the very
     * bottom of the viewport. {@code (line == 0 && lineAnchor == ANCHOR_TYPE_END)} and {@code (line
     * == -1 && lineAnchor == ANCHOR_TYPE_START)} position cues entirely outside of the viewport.
     * {@code (line == 1 && lineAnchor == ANCHOR_TYPE_END)} positions a cue so that only the last
     * line is visible at the top of the viewport. {@code (line == -2 && lineAnchor ==
     * ANCHOR_TYPE_START)} position a cue so that only its first line is visible at the bottom of
     * the viewport.
     */
     ...
     * bitmap should be displayed at its natural height given the bitmap dimensions and the
     * specified {@link #size}.
     */
     ...
     * @param horizontalPosition       The position of the horizontal anchor within the viewport,
     ...
     *                                 {@link #ANCHOR_TYPE_MIDDLE}, {@link #ANCHOR_TYPE_END} and
     *                                 {@link #TYPE_UNSET}.
     * @param verticalPosition         The position of the vertical anchor within the viewport,
     *                                 expressed as a fraction of the viewport height.
     ...
     * @param height                   The height of the cue as a fraction of the viewport height,
     *                                 or {@link #DIMEN_UNSET} if the bitmap should be displayed at
     *                                 its natural height for the specified {@code width}.
     */
    public Cue(
            Bitmap bitmap,
