...
public interface Subtitle {
     ...
     * @return The index of the next event, or {@link C#INDEX_UNSET} if there are no events after
     * the specified time.
     */
    int getNextEventTimeIndex(long timeUs);

    /**
     * Returns the number of event times, where events are defined as points in time at which the
     * cues returned by {@link #getCues(long)} changes.
     *
