...
public final class Cea608Decoder extends CeaDecoder {
     ...
     * non-displayed memory and held there until the {@link #CTRL_END_OF_CAPTION} command is
     * received, at which point the non-displayed memory becomes the displayed memory (and vice
     * versa).
     */
    ...
    /**
     * TEXT commands are switching to TEXT service. All consecutive incoming data must be filtered
     * out until a command is received that switches back to the CAPTION service.
     */
     ...
     * #CTRL_RESUME_CAPTION_LOADING} command has been received, this command forces the receiver
     * into pop-on style.
     */
