...
public final class Cea708InitializationData {
    ...
    /**
     * Whether the closed caption service is formatted for displays with 16:9 aspect ratio. If
     * false, the closed caption service is formatted for 4:3 displays.
     */
     ...
     *
     * @param isWideAspectRatio Whether the closed caption service is formatted for displays with
     *                          16:9 aspect ratio.
