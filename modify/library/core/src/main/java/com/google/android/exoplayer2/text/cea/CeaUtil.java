...
public final class CeaUtil {
     ...
     * @param seiBuffer          The unescaped SEI NAL unit data, excluding the NAL unit start code
     *                           and type.
    ...
    /**
     * Consumes caption data (cc_data), writing the content as samples to all of the provided
     * outputs.
     *
     * @param presentationTimeUs The presentation time in microseconds for any samples.
