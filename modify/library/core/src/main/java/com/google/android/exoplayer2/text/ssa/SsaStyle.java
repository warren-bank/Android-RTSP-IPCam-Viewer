...
/* package */ final class SsaStyle {
    ...
    /* package */ static final class Overrides {
         ...
         * \move(x1,y1,x2,y2,startTime,endTime)} (startTime and endTime are optional). In the case
         * of {@code \move()}, this returns {@code (x2, y2)} (i.e. the end position of the move).
         *
