...
public final class WebvttParserUtil {
     ...
     * reached without a cue header being found. In the case that a cue header is found, groups 1, 2
     * and 3 of the returned matcher contain the start time, end time and settings list.
     */
    @Nullable
