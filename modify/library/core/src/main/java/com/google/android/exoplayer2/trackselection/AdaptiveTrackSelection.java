...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static class Factory implements TrackSelection.Factory {
        ...
        /**
         * @deprecated Use {@link #Factory()} instead. Custom bandwidth meter should be directly
         * passed to the player in {@link SimpleExoPlayer.Builder}.
         */
        @Deprecated
         ...
         *
         * @param minDurationForQualityIncreaseMs   The minimum duration of buffered data required
         *                                          for the selected track to switch to one of
         *                                          higher quality.
         * @param maxDurationForQualityDecreaseMs   The maximum duration of buffered data required
         *                                          for the selected track to switch to one of lower
         *                                          quality.
         * @param minDurationToRetainAfterDiscardMs When switching to a track of significantly
         *                                          higher quality, the selection may indicate that
         *                                          media already buffered at the lower quality can
         *                                          be discarded to speed up the switch. This is the
         *                                          minimum duration of media that must be retained
         *                                          at the lower quality.
         * @param bandwidthFraction                 The fraction of the available bandwidth that the
         *                                          selection should consider available for use.
         *                                          Setting to a value less than 1 is recommended to
         *                                          account for inaccuracies in the bandwidth
         *                                          estimator.
         */
        public Factory(
        ...
        /**
         * @deprecated Use {@link #Factory(int, int, int, float)} instead. Custom bandwidth meter
         * should be directly passed to the player in {@link SimpleExoPlayer.Builder}.
         */
        @Deprecated
        @SuppressWarnings("deprecation")
        public Factory(
         ...
         * Creates an adaptive track selection factory.
         *
         * @param minDurationForQualityIncreaseMs              The minimum duration of buffered data
         *                                                     required for the selected track to
         *                                                     switch to one of higher quality.
         * @param maxDurationForQualityDecreaseMs              The maximum duration of buffered data
         *                                                     required for the selected track to
         *                                                     switch to one of lower quality.
         * @param minDurationToRetainAfterDiscardMs            When switching to a track of
         *                                                     significantly higher quality, the
         *                                                     selection may indicate that media
         *                                                     already buffered at the lower quality
         *                                                     can be discarded to speed up the
         *                                                     switch. This is the minimum duration
         *                                                     of media that must be retained at the
         *                                                     lower quality.
         * @param bandwidthFraction                            The fraction of the available
         *                                                     bandwidth that the selection should
         *                                                     consider available for use. Setting
         *                                                     to a value less than 1 is recommended
         *                                                     to account for inaccuracies in the
         *                                                     bandwidth estimator.
         * @param bufferedFractionToLiveEdgeForQualityIncrease For live streaming, the fraction of
         *                                                     the duration from current playback
         *                                                     position to the live edge that has to
         *                                                     be buffered before the selected track
         *                                                     can be switched to one of higher
         *                                                     quality. This parameter is only
         *                                                     applied when the playback position is
         *                                                     closer to the live edge than {@code
         *                                                     minDurationForQualityIncreaseMs},
         *                                                     which would otherwise prevent
         *                                                     switching to a higher quality from
         *                                                     happening.
         * @param minTimeBetweenBufferReevaluationMs           The track selection may periodically
         *                                                     reevaluate its buffer and discard
         *                                                     some chunks of lower quality to
         *                                                     improve the playback quality if
         *                                                     network conditions have changed. This
         *                                                     is the minimum duration between 2
         *                                                     consecutive buffer reevaluation
         *                                                     calls.
        ...
        /**
         * @deprecated Use {@link #Factory(int, int, int, float, float, long, Clock)} instead.
         * Custom bandwidth meter should be directly passed to the player in {@link
         ...
         * @param bandwidthMeter           A {@link BandwidthMeter} which can be used to select
         *                                 tracks.
         * @param tracks                   The indices of the selected tracks in the track group.
         * @param totalFixedTrackBandwidth The total bandwidth used by all non-adaptive tracks, in
         *                                 bits per second.
    ...
    /**
     * @param group          The {@link TrackGroup}.
     * @param tracks         The indices of the selected tracks within the {@link TrackGroup}. Must
     *                       not be empty. May be in any order.
    ...
    /**
     * @param group                                        The {@link TrackGroup}.
     * @param tracks                                       The indices of the selected tracks within
     *                                                     the {@link TrackGroup}. Must not be
     *                                                     empty. May be in any order.
     * @param bandwidthMeter                               Provides an estimate of the currently
     *                                                     available bandwidth.
     * @param reservedBandwidth                            The reserved bandwidth, which shouldn't
     *                                                     be considered available for use, in bits
     *                                                     per second.
     * @param minDurationForQualityIncreaseMs              The minimum duration of buffered data
     *                                                     required for the selected track to switch
     *                                                     to one of higher quality.
     * @param maxDurationForQualityDecreaseMs              The maximum duration of buffered data
     *                                                     required for the selected track to switch
     *                                                     to one of lower quality.
     * @param minDurationToRetainAfterDiscardMs            When switching to a track of
     *                                                     significantly higher quality, the
     *                                                     selection may indicate that media already
     *                                                     buffered at the lower quality can be
     *                                                     discarded to speed up the switch. This is
     *                                                     the minimum duration of media that must
     *                                                     be retained at the lower quality.
     * @param bandwidthFraction                            The fraction of the available bandwidth
     *                                                     that the selection should consider
     *                                                     available for use. Setting to a value
     *                                                     less than 1 is recommended to account for
     ...
     *                                                     duration from current playback position
     *                                                     to the live edge that has to be buffered
     *                                                     before the selected track can be switched
     *                                                     to one of higher quality. This parameter
     *                                                     is only applied when the playback
     *                                                     position is closer to the live edge than
     *                                                     {@code minDurationForQualityIncreaseMs},
     *                                                     which would otherwise prevent switching
     *                                                     to a higher quality from happening.
     * @param minTimeBetweenBufferReevaluationMs           The track selection may periodically
     *                                                     reevaluate its buffer and discard some
     *                                                     chunks of lower quality to improve the
     *                                                     playback quality if network condition has
     *                                                     changed. This is the minimum duration
     *                                                     between 2 consecutive buffer reevaluation
     *                                                     calls.
     */
     ...
     *                              being the total bandwidth and [1] being the allocated
     *                              bandwidth.
     */
     ...
     *                         Format#bitrate} if a more accurate estimate of the current track
    ...
    /**
     * Called from {@link #evaluateQueueSize(long, List)} to determine whether an evaluation should
     * be performed.
     *
    ...
    /**
     * Called from {@link #evaluateQueueSize(long, List)} to determine the minimum duration of
     * buffer to retain after discarding chunks.
     *
    ...
    /**
     * Returns idealized switch points for each switch between consecutive track selection
     * bitrates.
     *
     ...
     *
     * @param checkpoints     Output checkpoints with [selectionIndex][checkpointIndex][2] where
     *                        [0]=Total bitrate and [1]=Allocated bitrate.
     * @param checkpointIndex The checkpoint index.
     * @param trackBitrates   The track bitrates with [selectionIndex][trackIndex].
     * @param selectedTracks  The indices of selected tracks for each selection for this
     *                        checkpoint.
     */
