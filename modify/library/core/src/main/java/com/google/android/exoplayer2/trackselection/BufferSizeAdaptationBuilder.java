...
public final class BufferSizeAdaptationBuilder {
    ...
    public interface DynamicFormatFilter {
        ...
        /**
         * Called when updating the selected track to determine whether a candidate track is
         * allowed. If no format is allowed or eligible, the lowest quality format will be used.
         *
         ...
         *                           Format#bitrate} if a more accurate estimate of the current
         *                           track bitrate is available.
    ...
    /**
     * The default offset the current duration of buffered media must deviate from the ideal
     * duration of buffered media for the currently selected format, before the selected format is
     * changed.
     */
     ...
     * should consider available for use. Setting to a value less than 1 is recommended to account
    ...
    /**
     * During start-up phase, the default minimum duration of buffered media required for the
     * selected track to switch to one of higher quality based on measured bandwidth.
     */
     ...
     *
     * @param minBufferMs                      The minimum duration of media that the player will
     *                                         attempt to ensure is buffered at all times, in
     *                                         milliseconds.
     * @param maxBufferMs                      The maximum duration of media that the player will
     *                                         attempt to buffer, in milliseconds.
     * @param bufferForPlaybackMs              The duration of media that must be buffered for
     *                                         playback to start or resume following a user action
     *                                         such as a seek, in milliseconds.
     * @param bufferForPlaybackAfterRebufferMs The default duration of media that must be buffered
     *                                         for playback to resume after a rebuffer, in
     *                                         milliseconds. A rebuffer is defined to be caused by
     ...
     *                           the ideal duration of buffered media for the currently selected
     *                           format, before the selected format is changed. This value must be
     *                           smaller than {@code maxBufferMs - minBufferMs}.
     * @return This builder, for convenience.
     * @throws IllegalStateException If {@link #buildPlayerComponents()} has already been called.
     */
    ...
    /**
     * Sets track selection parameters used during the start-up phase before the selection can be
     * made purely on based on buffer size. During the start-up phase the selection is based on the
     * current bandwidth estimate.
     *
     * @param bandwidthFraction             The fraction of the available bandwidth that the
     *                                      selection should consider available for use. Setting to
     *                                      a value less than 1 is recommended to account for
