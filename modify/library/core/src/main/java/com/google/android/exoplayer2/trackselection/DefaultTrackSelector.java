 ...
 * simplify track selection code (e.g. you don't have to listen for changes in the available tracks
...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        /**
         * @deprecated {@link Context} constraints will not be set using this constructor. Use
         * {@link #ParametersBuilder(Context)} instead.
         */
        @Deprecated
         ...
         *
         * <p>Adaptations between different MIME types may not be completely seamless, in which
         * case
         ...
         *
         * <p>Enables or disables tunneling. To enable tunneling, pass an audio session id to use
         * when
         ...
         *
         * <p>Passing a {@code null} override will cause the renderer to be disabled when the
         * {@link
         * TrackGroupArray} mapped to it matches the one provided. When the {@link TrackGroupArray}
         * does not match a {@code null} override has no effect. Hence a {@code null} override
         * differs from disabling the renderer using {@link #setRendererDisabled(int, boolean)}
         * because the renderer is disabled conditionally on the {@link TrackGroupArray} mapped to
         * it, where-as {@link #setRendererDisabled(int, boolean)} disables the renderer
         * unconditionally.
         *
         ...
         *
         * @param rendererIndex The renderer index.
         * @param groups        The {@link TrackGroupArray} for which the override should be
         *                      applied.
        ...
        /**
         * Clears a track selection override for the specified renderer and {@link
         * TrackGroupArray}.
         *
         * @param rendererIndex The renderer index.
         * @param groups        The {@link TrackGroupArray} for which the override should be
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        /**
         * @deprecated This instance does not have {@link Context} constraints configured. Use
         * {@link #getDefaults(Context)} instead.
         */
        @Deprecated
        public static final Parameters DEFAULT_WITHOUT_VIEWPORT = DEFAULT_WITHOUT_CONTEXT;
         ...
         * #maxVideoBitrate} constraints when no selection can be made otherwise. The default value
         * is {@code true}.
         */
        public final boolean exceedVideoConstraintsIfNecessary;
        /**
         * Whether to allow adaptive video selections containing mixed MIME types. Adaptations
         * between different MIME types may not be completely seamless, in which case {@link
         ...
         * only tracks suitable for the viewport are selected. The default value is the physical
         ...
         * between different MIME types may not be completely seamless. The default value is {@code
         * false}.
         */
        ...
        /**
         * Returns whether there is an override for the specified renderer and {@link
         * TrackGroupArray}.
         *
         * @param rendererIndex The renderer index.
     ...
     * passed directly to the player in {@link com.google.android.exoplayer2.SimpleExoPlayer.Builder}.
     */
    @Deprecated
    @SuppressWarnings("deprecation")
     ...
     *                                                track (in that order).
     * @param rendererMixedMimeTypeAdaptationSupports The {@link AdaptiveSupport} for mixed MIME
     ...
     * @param formatSupports                  The {@link Capabilities} for each mapped track,
     *                                        indexed by renderer, track group and track (in that
     *                                        order).
     ...
     *
     * @param groups                The {@link TrackGroupArray} mapped to the renderer.
     * @param formatSupport         The {@link Capabilities} for each mapped track, indexed by
     *                              renderer, track group and track (in that order).
     * @param params                The selector's current constraint parameters.
     * @param selectedAudioLanguage The language of the selected audio track. May be null if the
     *                              selected text track declares no language or no text track was
     *                              selected.
     ...
     * @param groups        The {@link TrackGroupArray} mapped to the renderer.
     * @param formatSupport The {@link Capabilities} for each mapped track, indexed by renderer,
     ...
     *
     * @param formatSupports The {@link Capabilities} for each track, indexed by group index and
     *                       track index (in that order).
     ...
     * partly, a score of 2 if the languages don't match but belong to the same main language, a
     * score of 1 if the format language is undetermined and such a match is allowed, and a score of
     * 0 if the languages don't match at all.
     */
