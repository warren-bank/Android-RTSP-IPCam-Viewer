...
public abstract class MappingTrackSelector extends TrackSelector {
    ...
    public static final class MappedTrackInfo {
         ...
         * One of {@link #RENDERER_SUPPORT_NO_TRACKS}, {@link #RENDERER_SUPPORT_UNSUPPORTED_TRACKS},
         * {@link #RENDERER_SUPPORT_EXCEEDS_CAPABILITIES_TRACKS} or {@link
        ...
        /**
         * The renderer has tracks mapped to it and at least one is of a supported type, but all
         * such tracks exceed the renderer's capabilities. In other words, {@link
         * #getTrackSupport(int, int, int)} returns {@link RendererCapabilities#FORMAT_EXCEEDS_CAPABILITIES}
         * for at least one track mapped to the renderer, but does not return {@link
         ...
         * @param rendererTrackGroups                   The {@link TrackGroup}s mapped to each
         *                                              renderer.
         * @param rendererMixedMimeTypeAdaptiveSupports The {@link AdaptiveSupport} for mixed MIME
         *                                              type adaptation for the renderer.
         * @param rendererFormatSupports                The {@link Capabilities} for each mapped
         *                                              track, indexed by renderer, track group and
         *                                              track (in that order).
         * @param unmappedTrackGroups                   {@link TrackGroup}s not mapped to any
         *                                              renderer.
         */
        ...
        /**
         * Returns the extent to which tracks of a specified type are supported. This is the best
         * level of support obtained from {@link #getRendererSupport(int)} for all renderers that
         * handle the specified type. If no such renderers exist then {@link
         * #RENDERER_SUPPORT_NO_TRACKS} is returned.
         *
         ...
         * #getTrackSupport(int, int, int)} returns {@link RendererCapabilities#FORMAT_EXCEEDS_CAPABILITIES}
         * are also considered if {@code includeCapabilitiesExceededTracks} is set to {@code true}.
         * Tracks for which {@link #getTrackSupport(int, int, int)} returns {@link
         * RendererCapabilities#FORMAT_UNSUPPORTED_DRM}, {@link RendererCapabilities#FORMAT_UNSUPPORTED_TYPE}
         * or {@link RendererCapabilities#FORMAT_UNSUPPORTED_SUBTYPE} are never considered.
         *
         * @param rendererIndex                     The renderer index.
         * @param groupIndex                        The index of the track group.
         * @param includeCapabilitiesExceededTracks Whether tracks that exceed the capabilities of
         *                                          the renderer are included when determining
         *                                          support.
        ...
        /**
         * Returns the extent to which a renderer supports adaptation between specified tracks
         * within a {@link TrackGroup}.
         *
         * @param rendererIndex The renderer index.
         * @param groupIndex    The index of the track group.
         * @return The {@link AdaptiveSupport}.
    ...
    /**
     * Given mapped track information, returns a track selection and configuration for each
     * renderer.
     *
     * @param mappedTrackInfo                        Mapped track information.
     * @param rendererFormatSupports                 The {@link Capabilities} for ach mapped track,
     *                                               indexed by renderer, track group and track (in
     *                                               that order).
     * @param rendererMixedMimeTypeAdaptationSupport The {@link AdaptiveSupport} for mixed MIME type
     *                                               adaptation for the renderer.
     * @return A pair consisting of the track selections and configurations for each renderer. A
     * null configuration indicates the renderer should be disabled, in which case the track
     * selection will also be null. A track selection may also be null for a non-disabled renderer
     * if {@link RendererCapabilities#getTrackType()} is {@link C#TRACK_TYPE_NONE}.
     ...
     * RendererCapabilities#FORMAT_EXCEEDS_CAPABILITIES}, {@link RendererCapabilities#FORMAT_UNSUPPORTED_DRM}
     * and {@link RendererCapabilities#FORMAT_UNSUPPORTED_SUBTYPE}. In the case that two or more
     * renderers report the same level of support, the renderer with the lowest index is
     * associated.
     * <p>
     ...
     *
     * @param rendererCapabilities The {@link RendererCapabilities} of the renderers.
     * @return An array containing the {@link AdaptiveSupport} for mixed MIME type adaptation for
     * the renderer.
