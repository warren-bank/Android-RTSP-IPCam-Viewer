...
public class TrackSelectionParameters implements Parcelable {
    ...
    public static class Builder {
        ...
        /**
         * @param initialValues The {@link TrackSelectionParameters} from which the initial values
         *                      of the builder are obtained.
         */
         ...
         *                               or {@code null} to select the default track, or the first
         *                               track if there's no default.
         * @return This builder.
         */
         ...
         *
         * <p>Does nothing for API levels &lt; 19 or when the {@link CaptioningManager} is
         * disabled.
         *
         ...
         *                              {@code null} to select the default track if there is one, or
         *                              no track otherwise.
         * @return This builder.
         */
         ...
         * unset.
         *
         * @param selectUndeterminedTextLanguage Whether a text track with undetermined language
         *                                       should be selected if no preferred language track
         *                                       is available.
         * @return This builder.
         */
     ...
     * Preferred text language and role flags} configured to the accessibility settings of {@link
     * CaptioningManager}.
     * </ul>
     */
     ...
     * or the language of the accessibility {@link CaptioningManager} if enabled.
     */
    @Nullable
    public final String preferredTextLanguage;
    /**
     * The preferred {@link C.RoleFlags} for text tracks. {@code 0} selects the default track if
     * there is one, or no track otherwise. The default value is {@code 0}, or {@link
     * C#ROLE_FLAG_SUBTITLE} | {@link C#ROLE_FLAG_DESCRIBES_MUSIC_AND_SOUND} if the accessibility
     * {@link CaptioningManager} is enabled.
     */
    @C.RoleFlags
