...
public final class TrackSelectionUtil {
     ...
     *
     * @param definitions                   The list of track selection {@link Definition
     *                                      definitions}. May include null values.
     ...
     * @param override        An optional override for the renderer. If null, no override will be
     *                        set and an existing override for this renderer will be cleared.
