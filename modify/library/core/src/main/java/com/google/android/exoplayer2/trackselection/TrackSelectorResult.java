...
public final class TrackSelectorResult {
     ...
     * @param selections             A {@link TrackSelectionArray} containing the selection for each
     *                               renderer.
     * @param info                   An opaque object that will be returned to {@link
     *                               TrackSelector#onSelectionActivated(Object)} should the
     *                               selection be activated.
     */
    ...
    /**
     * Returns whether this result is equivalent to {@code other} for the renderer at the given
     * index. The results are equivalent if they have equal track selections and configurations for
     * the renderer.
     *
     * @param other The other {@link TrackSelectorResult}. May be null, in which case {@code false}
     *              will be returned.
