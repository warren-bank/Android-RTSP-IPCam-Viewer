...
public final class Allocation {
    ...
    /**
     * The array containing the allocated space. The allocated space might not be at the start of
     * the array, and so {@link #offset} must be used when indexing into it.
     */
