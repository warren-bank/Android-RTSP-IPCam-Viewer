 ...
 * rawresource:///resourceId, where rawResourceId is the integer identifier of the raw resource).
 ...
 * if constructed using {@link #DefaultDataSource(Context, String, boolean)}, or any other schemes
 * supported by a base data source if constructed using {@link #DefaultDataSource(Context,
 * DataSource)}.
 * </ul>
 */
public final class DefaultDataSource implements DataSource {
     ...
     *                                    to HTTPS and vice versa) are enabled when fetching remote
     *                                    data.
     */
     ...
     * @param context                     A context.
     * @param userAgent                   The User-Agent to use when requesting remote data.
     * @param connectTimeoutMillis        The connection timeout that should be used when requesting
     *                                    remote data, in milliseconds. A timeout of zero is
     *                                    interpreted as an infinite timeout.
     * @param readTimeoutMillis           The read timeout that should be used when requesting
     *                                    remote data, in milliseconds. A timeout of zero is
     *                                    interpreted as an infinite timeout.
     * @param allowCrossProtocolRedirects Whether cross-protocol redirects (i.e. redirects from HTTP
     *                                    to HTTPS and vice versa) are enabled when fetching remote
     ...
     * other than file, asset and content.
     *
     * @param context        A context.
     * @param baseDataSource A {@link DataSource} to use for URI schemes other than file, asset and
     *                       content. This {@link DataSource} should normally support at least
     *                       http(s).
     */
