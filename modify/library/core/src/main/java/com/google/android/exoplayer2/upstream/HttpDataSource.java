...
public interface HttpDataSource extends DataSource {
    ...
    interface Factory extends DataSource.Factory {
        ...
        /**
         * Sets a default request header for {@link HttpDataSource} instances created by the
         * factory.
         *
        ...
        /**
         * Clears a default request header for {@link HttpDataSource} instances created by the
         * factory.
         *
         * @param name The name of the header field.
         * @deprecated Use {@link #getDefaultRequestProperties} instead.
        ...
        /**
         * Clears all default request headers for all {@link HttpDataSource} instances created by
         * the factory.
         *
         * @deprecated Use {@link #getDefaultRequestProperties} instead.
         */
    ...
    final class RequestProperties {
        ...
        /**
         * Sets the specified property {@code value} for the specified {@code name}. If a property
         * for this name previously existed, the old value is replaced by the specified value.
         *
         ...
         * value is replaced by the specified value. If a property previously existed and is not in
         * the map, the property is left unchanged.
         *
     ...
     *
     * <p>Note: {@link HttpDataSource} implementations are advised to set request headers passed
     * via
     ...
     * header value set with this method should be preferred when connecting with the data source.
     * See {@link #open}.
     *
     * @param name  The name of the header field.
     * @param value The value of the field.
     ...
     * {@link #open} call. Otherwise, returns a negative value.
     */
    int getResponseCode();
