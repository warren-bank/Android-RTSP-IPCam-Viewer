 ...
 * errors whose load is retried are propagated according to {@link #getMinimumLoadableRetryCount(int)}.
 *
...
public interface LoadErrorHandlingPolicy {
     ...
     *
     * @param dataType       One of the {@link C C.DATA_TYPE_*} constants indicating the type of
     *                       data to load.
     * @param loadDurationMs The duration in milliseconds of the load from the start of the first
     *                       load attempt up to the point at which the error occurred.
     * @param exception      The load error.
     * @param errorCount     The number of errors this load has encountered, including this one.
     * @return The blacklist duration in milliseconds, or {@link C#TIME_UNSET} if the resource
     ...
     *
     * <p>{@link Loader} clients may ignore the retry delay returned by this method in order to
     * wait
