...
public final class ResolvingDataSource implements DataSource {
    ...
    public interface Resolver {
         ...
         * @throws IOException If an {@link IOException} occurred while resolving the {@link
         *                     DataSpec}.
         */
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        /**
         * @param upstreamFactory The wrapped {@link DataSource.Factory} for handling resolved
         *                        {@link DataSpec DataSpecs}.
