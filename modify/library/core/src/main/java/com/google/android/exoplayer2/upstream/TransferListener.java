 ...
 * #onTransferStart(DataSource, DataSpec, boolean)} is called. Note that this only happens if the
 ...
 * boolean)} will have exactly one corresponding call to {@link #onTransferEnd(DataSource, DataSpec,
 * boolean)}.
 * </ol>
 */
