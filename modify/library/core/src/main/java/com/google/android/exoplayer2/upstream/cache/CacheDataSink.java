...
public final class CacheDataSink implements DataSink {
     ...
     *                     the maximum size of a cache file in bytes. If set to {@link
     *                     C#LENGTH_UNSET} then no fragmentation will occur. Using a small value
     *                     allows for finer-grained cache eviction policies, at the cost of
     *                     increased overhead both on the cache implementation and the file system.
