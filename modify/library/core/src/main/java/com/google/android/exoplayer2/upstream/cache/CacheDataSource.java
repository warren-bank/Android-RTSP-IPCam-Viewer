...
public final class CacheDataSource implements DataSource {
    ...
    /**
     * A flag indicating whether we will block reads if the cache key is locked. If unset then data
     * is read from upstream if the cache key is locked, regardless of whether the data is cached.
     */
     ...
     * This flag is provided for legacy reasons only.
     */
    ...
    public interface EventListener {
         ...
         * @param cachedBytesRead Total bytes read from the cache since this method was last
         *                        called.
         */
     ...
     * @param cache    The cache.
     * @param upstream A {@link DataSource} for reading data not in the cache.
     * @param flags    A combination of {@link #FLAG_BLOCK_ON_CACHE}, {@link
     *                 #FLAG_IGNORE_CACHE_ON_ERROR} and {@link #FLAG_IGNORE_CACHE_FOR_UNSET_LENGTH_REQUESTS},
     *                 or 0.
     */
     ...
     * @param cacheWriteDataSink  A {@link DataSink} for writing data to the cache. If null, cache
     ...
     *                   reading from {@link #upstreamDataSource}, which is the currently open
     *                   source.
     */
