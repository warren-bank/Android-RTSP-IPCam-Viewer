...
public final class CacheUtil {
    ...
    public interface ProgressListener {
         ...
         * @param newBytesCached The number of bytes that have been newly cached since the last
         *                       progress update.
         */
    ...
    /**
     * Caches the data defined by {@code dataSpec}, skipping already cached data. Caching stops
     * early if the end of the input is reached.
     *
     ...
     * @throws InterruptedException If the thread was interrupted directly or via {@code
     *                              isCanceled}.
     */
    @WorkerThread
     ...
     *
     * <p>If a {@link PriorityTaskManager} is given, it's used to pause and resume caching
     * depending
     ...
     * @param priorityTaskManager If not null it's used to check whether it is allowed to proceed
     *                            with caching.
     ...
     *
     * @param dataSpec               Defines the data to be read. {@code absoluteStreamPosition} and
     *                               {@code length} fields are overwritten by the following
     *                               parameters.
     * @param absoluteStreamPosition The absolute position of the data to be read.
     * @param length                 Length of the data to be read, or {@link C#LENGTH_UNSET} if it
     *                               is unknown.
     ...
     * @param progressNotifier       A notifier through which to report progress updates, or {@code
     *                               null}.
     * @param isLastBlock            Whether this read block is the last block of the content.
     * @param isCanceled             An optional flag that will interrupt caching if set to true.
     * @return Number of read bytes, or 0 if no data is available because the end of the opened
