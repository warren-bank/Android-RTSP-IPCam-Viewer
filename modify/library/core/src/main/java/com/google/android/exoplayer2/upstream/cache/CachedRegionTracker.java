...
public final class CachedRegionTracker implements Cache.Listener {
     ...
     * byte offset does not fall within a cached region then {@link #NOT_CACHED} is returned. If the
     * cached region extends to the end of the stream, {@link #CACHED_TO_END} is returned.
     *
