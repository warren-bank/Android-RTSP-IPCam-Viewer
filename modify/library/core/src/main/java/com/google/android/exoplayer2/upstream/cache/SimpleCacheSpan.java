...
/* package */ final class SimpleCacheSpan extends CacheSpan {
    ...
    /**
     * Returns a new {@link File} instance from {@code cacheDir}, {@code id}, {@code position},
     * {@code timestamp}.
     *
     ...
     *               underlying file system. Querying the underlying file system can be expensive,
     *               so callers that already know the length of the file should pass it explicitly.
     ...
     *
     * @param file               The cache file.
     * @param length             The length of the cache file in bytes, or {@link C#LENGTH_UNSET} to
     *                           query the underlying file system. Querying the underlying file
     *                           system can be expensive, so callers that already know the length of
     *                           the file should pass it explicitly.
     ...
     * @return Upgraded cache file or {@code null} if the file name is not correctly formatted or
     ...
     * @param key                The cache key.
     * @param position           The position of the {@link CacheSpan} in the original stream.
     * @param length             The length of the {@link CacheSpan}, or {@link C#LENGTH_UNSET} if
     *                           this is an open-ended hole.
     * @param lastTouchTimestamp The last touch timestamp, or {@link C#TIME_UNSET} if {@link
     *                           #isCached} is false.
     * @param file               The file corresponding to this {@link CacheSpan}, or null if it's a
     *                           hole.
     */
     ...
     * @throws IllegalStateException If called on a non-cached span (i.e. {@link #isCached} is
     *                               false).
     */
