...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
     ...
     * {@link #SECURE_MODE_SURFACELESS_CONTEXT} or {@link #SECURE_MODE_PROTECTED_PBUFFER}.
     */
    @Documented
    ...
    /**
     * @param handler The {@link Handler} that will be used to call {@link SurfaceTexture#updateTexImage()}
     *                to update images on the {@link SurfaceTexture}. Note that {@link #init(int)}
     *                has to be called on the same looper thread as the {@link Handler}'s looper.
     */
     ...
     *                 SurfaceTexture#updateTexImage()} to update images on the {@link
     *                 SurfaceTexture}. Note that {@link #init(int)} has to be called on the same
     *                 looper thread as the looper of the {@link Handler}.
     * @param callback The {@link TextureImageListener} to be called when the texture image on
     *                 {@link SurfaceTexture} has been updated. This callback will be called on the
     *                 same handler thread as the {@code handler}.
     */
    ...
    /**
     * Returns the wrapped {@link SurfaceTexture}. This can only be called after {@link
     * #init(int)}.
     */
