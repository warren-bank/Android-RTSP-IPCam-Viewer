...
public final class GlUtil {
    ...
    /**
     * If there is an OpenGl error, logs the error and if {@link ExoPlayerLibraryInfo#GL_ASSERTIONS_ENABLED}
     * is true throws a {@link RuntimeException}.
     */
     ...
     * @param fragmentCode GLES20 fragment shader program as arrays of strings. Strings are joined
