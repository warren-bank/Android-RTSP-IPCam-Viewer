...
public final class MimeTypes {
    ...
    /**
     * Registers a custom MIME type. Most applications do not need to call this method, as handling
     * of standard MIME types is built in. These built-in MIME types take precedence over any
     * registered via this method. If this method is used, it must be called before creating any
     * player(s).
     *
     ...
     *                    This value is ignored if the top-level type of {@code mimeType} is audio,
     *                    video or text.
     */
    ...
    /**
     * Returns the {@link C}{@code .TRACK_TYPE_*} constant that corresponds to a specified MIME
     * type. {@link C#TRACK_TYPE_UNKNOWN} if the MIME type is not known or the mapping cannot be
     * established.
     *
     * @param mimeType The MIME type.
     * @return The {@link C}{@code .TRACK_TYPE_*} constant that corresponds to a specified MIME
     * type.
     */
    ...
    /**
     * Returns the top-level type of {@code mimeType}, or null if {@code mimeType} is null or does
     * not contain a forward slash character ({@code '/'}).
     */
