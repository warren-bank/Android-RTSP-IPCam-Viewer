...
public final class NotificationUtil {
     ...
     * NotificationChannel} and {@link NotificationManager#createNotificationChannel(NotificationChannel)}
     * for details.
     *
     * @param context               A {@link Context}.
     * @param id                    The id of the channel. Must be unique per package. The value may
     *                              be truncated if it's too long.
     * @param nameResourceId        A string resource identifier for the user visible name of the
     *                              channel. The recommended maximum length is 40 characters. The
     *                              string may be truncated if it's too long. You can rename the
     *                              channel when the system locale changes by listening for the
     ...
     *                              the channel, or 0 if no description is provided. The recommended
     *                              maximum length is 300 characters. The value may be truncated if
     *                              it is too long. You can change the description of the channel
     *                              when the system locale changes by listening for the {@link
     *                              Intent#ACTION_LOCALE_CHANGED} broadcast.
     * @param importance            The importance of the channel. This controls how interruptive
     *                              notifications posted to this channel are. One of {@link
     *                              #IMPORTANCE_UNSPECIFIED}, {@link #IMPORTANCE_NONE}, {@link
     *                              #IMPORTANCE_MIN}, {@link #IMPORTANCE_LOW}, {@link
