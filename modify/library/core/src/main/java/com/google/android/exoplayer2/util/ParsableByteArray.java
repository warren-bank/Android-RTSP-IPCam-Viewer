...
public final class ParsableByteArray {
     ...
     * @throws IllegalArgumentException Thrown if the new position is neither in nor at the end of
     *                                  the array.
     */
     ...
     * default charset (UTF-8) is used. This method discards leading UTF-8 byte order marks, if
     * present.
     *
     * @return The line not including any line-termination characters, or null if the end of the
     * data has already been reached.
     */
    @Nullable
