...
public final class UriUtil {
     ...
     * authority part is non-empty (in this case the double-slash means the first segment is
     * empty).
     */
    ...
    /**
     * Like {@link #resolve(String, String)}, but returns a {@link Uri} instead of a {@link
     * String}.
     *
