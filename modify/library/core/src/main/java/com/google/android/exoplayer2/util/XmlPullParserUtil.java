...
public final class XmlPullParserUtil {
    ...
    /**
     * Returns whether the current event is a start tag with the specified name. If the current
     * event has a raw name then its prefix is stripped before matching.
     *
     * @param xpp  The {@link XmlPullParser} to query.
     * @param name The specified name.
     * @return Whether the current event is a start tag with the specified name.
