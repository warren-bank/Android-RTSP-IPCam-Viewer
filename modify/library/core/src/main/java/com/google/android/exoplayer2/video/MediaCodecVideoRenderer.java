 ...
 * scaling mode only applies if the {@link Surface} targeted by this renderer is owned by a {@link
...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
     ...
     * @param codecMaxValues                     Codec max values that should be used when
     *                                           configuring the decoder.
     * @param codecOperatingRate                 The codec operating rate, or {@link
     *                                           #CODEC_OPERATING_RATE_UNSET} if no codec operating
     *                                           rate should be set.
     ...
     *                                           {@link C#AUDIO_SESSION_ID_UNSET} if tunneling
     ...
     * incorrectly.
     *
     * <p>If true is returned then we fall back to releasing and re-instantiating the codec
     * instead.
     *
