...
public class VideoDecoderOutputBuffer extends OutputBuffer {
    ...
    /**
     * Supplemental data related to the output frame, if {@link #hasSupplementalData()} returns
     * true. If present, the buffer is populated with supplemental data from position 0 to its
     * limit.
     */
    @Nullable
     ...
     *                         present. It is safe to reuse the provided buffer after this method
     *                         returns.
     */
    public void init(
     ...
     * {@link #decoderPrivate}. Called via JNI after decoding completes.
     */
