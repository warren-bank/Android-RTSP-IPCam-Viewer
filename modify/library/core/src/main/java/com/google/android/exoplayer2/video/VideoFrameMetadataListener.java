...
public interface VideoFrameMetadataListener {
     ...
     *                           nanoseconds. If the platform API version of the device is less than
     *                           21, then this is the best effort.
     * @param format             The format associated with the frame.
     * @param mediaFormat        The framework media format associated with the frame, or {@code
     *                           null} if not known or not applicable (e.g., because the frame was
     *                           not output by a {@link android.media.MediaCodec MediaCodec}).
     */
