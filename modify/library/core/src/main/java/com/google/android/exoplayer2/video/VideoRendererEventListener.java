...
public interface VideoRendererEventListener {
     ...
     *
     * @param counters {@link DecoderCounters} that will be updated by the renderer for as long as
     *                 it remains enabled.
     */
     ...
     *                                 On earlier API levels this is not possible. Applications that
     *                                 use {@link TextureView} can apply the rotation by calling
     *                                 {@link TextureView#setTransform}. Applications that do not
     *                                 expect to encounter rotated videos can safely ignore this
     *                                 parameter.
     * @param pixelWidthHeightRatio    The width to height ratio of each pixel. For the normal case
     *                                 of square pixels this will be equal to 1.0. Different values
     *                                 are indicative of anamorphic content.
     */
     ...
     *
     * @param surface The {@link Surface} to which a first frame has been rendered, or {@code null}
     *                if the renderer renders to something that isn't a {@link Surface}.
     */
    ...
    final class EventDispatcher {
        ...
        /**
         * Invokes {@link VideoRendererEventListener#onVideoDecoderInitialized(String, long,
         * long)}.
         */
