...
public final class FrameRotationQueue {
    ...
    /**
     * Copies the rotation matrix with the greatest timestamp which is less than or equal to the
     * given timestamp to {@code matrix}. Removes all older rotations and the returned one from the
     * queue. Does nothing if there is no such rotation.
     *
     ...
     * Roll and tilt will not be compensated.
     *
