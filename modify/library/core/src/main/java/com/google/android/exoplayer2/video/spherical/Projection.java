...
public final class Projection {
     ...
     * @param verticalFovDegrees   Total latitudinal degrees that are covered by the sphere. Must be
     *                             in (0, 180].
    ...
    /**
     * Creates a Projection with dual mesh. Use {@link #Projection(Mesh, int)} if there is single
     * mesh for both eyes.
     *
