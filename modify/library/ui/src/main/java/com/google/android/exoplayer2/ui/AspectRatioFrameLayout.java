...
public final class AspectRatioFrameLayout extends FrameLayout {
    ...
    public interface AspectRatioListener {
         ...
         *
         * @param targetAspectRatio   The aspect ratio that has been set in {@link
         *                            #setAspectRatio(float)}
         * @param naturalAspectRatio  The natural aspect ratio of this view (before its width and
         *                            height are modified to satisfy the target aspect ratio).
     ...
     * natural aspect ratio and the requested aspect ratio falls below this threshold.
     *
     ...
     * reduce the number of view layers that need to be composited by the underlying system, which
