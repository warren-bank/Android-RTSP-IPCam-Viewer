...
public final class SubtitleView extends View implements TextOutput {
     ...
     *                         Set to false if {@code fractionOfHeight} should be interpreted as a
     *                         fraction of this view's remaining height after the top and bottom
     *                         padding has been subtracted.
     */
