...
public final class TrackSelectionDialogBuilder {
     ...
     *                        selection is shown.
     * @param callback        The {@link DialogCallback} invoked when a track selection has been
     *                        made.
     */
     ...
     *                      the dialog and which is updated when new tracks are selected in the
     *                      dialog.
     ...
     *
     * @param overrides The list of initial overrides to show. There must be at most one override
     ...
     *
     * <p>For the selection view to enable adaptive selection it is necessary both for this feature
     * to
    ...
    /**
     * Sets whether multiple overrides can be set and selected, i.e. tracks from multiple track
