...
public class TrackSelectionView extends LinearLayout {
    ...
    /**
     * Sets whether tracks from multiple track groups can be selected. This results in multiple
     * {@link SelectionOverride SelectionOverrides} to be returned by {@link #getOverrides()}.
     *
    ...
    /**
     * Initialize the view to select tracks for a specified renderer using {@link MappedTrackInfo}
     * and a set of {@link DefaultTrackSelector.Parameters}.
     *
     ...
     * @param overrides       List of initial overrides to be shown for this renderer. There must be
     *                        at most one override for each track group. If {@link
     *                        #setAllowMultipleOverrides(boolean)} hasn't been set to {@code true},
    ...
    /**
     * Returns the list of selected track selection overrides. There will be at most one override
